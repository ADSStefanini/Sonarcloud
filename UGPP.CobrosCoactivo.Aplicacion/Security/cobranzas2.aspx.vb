...
Partial Public Class cobranzas2
        ...
        Try
            ...
            If DtsDatos.Mandaniento_Pago.Rows.Count > 0 Then
                ...
                Select Case selectcod
                    Case "228", "013", "233", "354", "355", "356", "226", "363", "230", "214", "235", "315", "319", "320", "321", "353", "355", "352", "368", "351", "366", "367", "359", "360", "370", "350", "382", "383"
                        tipo = "AND D.TIPO = 1"
                    Case Else
                End Select
                ...
                Select Case selectcod
                    ...
                    Case "228", "013", "233", "354", "355", "356", "226", "363", "230", "214", "235", "315", "319", "320", "321", "353", "355", "352", "368", "316", "366", "367", "351", "352", "359", "360", "370", "350", "382", "383"
                        AdapterMT = New SqlClient.SqlDataAdapter(" SELECT TOP 1 A.EFINROEXP AS MAN_EXPEDIENTE,																																																		" &
                                                               ...
                                                               " 	   CASE WHEN H.NOMBRE ='SIN DATOS'THEN '' ELSE H.NOMBRE END AS Departamento,                                                                                                                                                                                                            " &
                                                               " 	   CASE WHEN I.NOMBRE ='SIN DATOS'THEN '' ELSE I.NOMBRE END AS Municipio,                                                                                                                                                                                                                 " &
                                                               " 	   k.nombre as Proyecto,ED_TipoPersona as DOCUMENTO,                                                                                                                                                                                                                " &
                                                               " 	   L.nombre as Revisor,                                                                                                                                                                                                                 " &
                                                               " 	   D.TIPO as Tipo_Deudor,F.codigo as codigotitulo,                                                                                                                                                                                                              " &
                                                               " 	   c.idunico as IdDireccion,A.EFINUMMEMO,E.MT_fecha_ejecutoria,A.EFIFECHAEXP, E.MT_FEC_EXI_LIQ                                                                                                                                                                                                                                 " &
                                                               " FROM  EJEFISGLOBAL A,                                                                                                                                                                                                                     " &
                                                               " 	  ENTES_DEUDORES B,                                                                                                                                                                                                                     " &
                                                               " 	  DIRECCIONES C ,                                                                                                                                                                                                                       " &
                                                               " 	  DEUDORES_EXPEDIENTES D,                                                                                                                                                                                                               " &
                                                               " 	  MAESTRO_TITULOS E,                                                                                                                                                                                                                    " &
                                                               " 	  TIPOS_TITULO F,                                                                                                                                                                                                                       " &
                                                               " 	  TIPOS_IDENTIFICACION G,                                                                                                                                                                                                               " &
                                                               " 	  DEPARTAMENTOS H,                                                                                                                                                                                                                      " &
                                                               " 	  MUNICIPIOS I,                                                                                                                                                                                                                         " &
                                                               " 	  FORMAS_NOTIFICACION J,                                                                                                                                                                                                                " &
                                                               " 	  USUARIOS K,                                                                                                                                                                                                                           " &
                                                               " 	  USUARIOS L                                                                                                                                                                                                                            " &
                                                               " WHERE A.EFINROEXP = D.NROEXP                                                                                                                                                                                                              " &
                                                               " AND   D.DEUDOR = B.ED_Codigo_Nit                                                                                                                                                                                                          " &
                                                               " AND   B.ED_Codigo_Nit = C.deudor                                                                                                                                                                                                          " &
                                                               " AND   E.MT_expediente = A.EFINROEXP                                                                                                                                                                                                       " &
                                                               " AND   F.codigo = E.MT_tipo_titulo                                                                                                                                                                                                         " &
                                                               " AND   G.codigo  = B.ED_TipoId                                                                                                                                                                                                             " &
                                                               " AND   H.codigo = C.Departamento                                                                                                                                                                                                           " &
                                                               " AND   I.codigo = C.Ciudad                                                                                                                                                                                                                 " &
                                                               " AND   J.codigo = E.MT_for_notificacion_titulo                                                                                                                                                                                             " &
                                                               " AND   K.codigo = A.EFIUSUASIG                                                                                                                                                                                                             " &
                                                               " AND   L.codigo = A.EFIUSUREV                                                                                                                                                                                                              " &
                                                               " AND  A.EFINROEXP = @EXPEDIENTE " & tipo & "                                                                                                                                                                                               " &
                                                               " ORDER BY TIPO", Ado)

                    Case "349", "358", "380"
                        AdapterMT = New SqlClient.SqlDataAdapter(" SELECT A.EFINROEXP AS MAN_EXPEDIENTE,																																																		" &
                                                               " 	   G.nombre AS ED_TipoId,ED_CODIGO_NIT + CASE WHEN ISNULL(ED_DigitoVerificacion,'') ='' THEN '' ELSE '-' END +CASE WHEN ED_DIGITOVERIFICACION =''THEN '' ELSE ISNULL(ED_DIGITOVERIFICACION,'') END AS ED_CODIGO_NIT, B.ED_Nombre, CASE WHEN ED_TipoPersona = '02' THEN 'Señor(a)' ELSE 'Doctor(a)' END AS ED_TipoPersona, CASE WHEN ED_TipoPersona = '02' THEN 'Cuidadano' ELSE 'Empresario(a)' END AS Cuidadano,  " &
                                                               " 	   C.Direccion,CASE WHEN C.EMAIL ='SIN DATOS' THEN '' ELSE C.EMAIL END AS EMAIL, (case when isnull( C.Movil,'') = '' then '' else  case when isnull( C.Movil,'')='Sin datos'or isnull( C.Movil ,'')= 'sin datos'or isnull( C.Movil ,'')= 'sin dato' then '' else C.Movil end end)	 + 		(case when isnull( C.Movil,'')='Sin datos'or isnull( C.Movil ,'')= 'sin datos'or isnull( C.Movil ,'')= 'sin dato' or isnull( C.Telefono ,'')='Sin datos' or isnull( C.Telefono ,'')= 'sin datos'or isnull( C.Telefono ,'')= 'sin dato' then '' else ' - ' end)		 + 	    (case when isnull( C.Telefono ,'') = '' then '' else case when isnull( C.Telefono ,'')='Sin datos' or isnull( C.Telefono ,'')= 'sin datos'or isnull( C.Telefono ,'')= 'sin dato' then '' else C.Telefono  end end ) as telefono,                                                                                     " &
                                                               " 	   E.MT_nro_titulo,F.nombre AS MT_Tipo_Titulo, E.MT_fec_expedicion_titulo,ISNULL(E.MT_fec_notificacion_titulo,'') AS MT_fec_notificacion_titulo,J.nombre AS MT_for_notificacion_titulo  ,'$ '+substring (replace(CAST(CONVERT(varchar, CAST(E.totaldeuda  AS money), 1) AS varchar),',','.'),1,  LEN(CAST(E.totaldeuda  AS money))-1)as Total_Deuda,E.totaldeuda,                                                                           " &
                                                               " 	   CASE WHEN H.NOMBRE ='SIN DATOS'THEN '' ELSE H.NOMBRE END AS Departamento,                                                                                                                                                                                                            " &
                                                               ...
                                                               " 	   c.idunico as IdDireccion,A.EFINUMMEMO,E.MT_fecha_ejecutoria,A.EFIFECHAEXP,M.BAN_DIRECCION AS DIRECCIONBANCARIA , M.BAN_TELEFONO AS TELEFONOBANCARIO , M.BAN_NOMBRE AS NOMBREBANCARIO, F.codigo as codigotitulo                       " &
                                                               " FROM  EJEFISGLOBAL A,                                                                                                                                                                                                                      " &
                                                               " 	  ENTES_DEUDORES B,                                                                                                                                                                                                                     " &
                                                               " 	  DIRECCIONES C ,                                                                                                                                                                                                                       " &
                                                               " 	  DEUDORES_EXPEDIENTES D,                                                                                                                                                                                                               " &
                    ...
                    Case "217", "219", "221", "222", "301", "307", "329"
                        ...
                        AdapterMT = New SqlClient.SqlDataAdapter(" SELECT A.EFINROEXP AS MAN_EXPEDIENTE, " &
                        " G.nombre AS ED_TipoId,ED_CODIGO_NIT + CASE WHEN ISNULL(ED_DigitoVerificacion,'') ='' THEN '' ELSE '-' END +CASE WHEN ED_DIGITOVERIFICACION =''THEN '' ELSE ISNULL(ED_DIGITOVERIFICACION,'') END AS ED_CODIGO_NIT, " &
                        " B.ED_Nombre, CASE WHEN ED_TipoPersona = '02' THEN 'Señor(a)' ELSE 'Doctor(a)' END AS ED_TipoPersona, CASE WHEN ED_TipoPersona = '02' THEN 'Cuidadano' ELSE 'Empresario(a)' END AS Cuidadano,  " &
                        " C.Direccion,CASE WHEN C.EMAIL ='SIN DATOS' THEN '' ELSE C.EMAIL END AS EMAIL, (case when isnull( C.Movil,'') = '' then '' else  case when isnull( C.Movil,'')='Sin datos'or isnull( C.Movil ,'')= 'sin datos'or isnull( C.Movil ,'')= 'sin dato' then '' else C.Movil end end)	 + 		(case when isnull( C.Movil,'')='Sin datos'or isnull( C.Movil ,'')= 'sin datos'or isnull( C.Movil ,'')= 'sin dato' or isnull( C.Telefono ,'')='Sin datos' or isnull( C.Telefono ,'')= 'sin datos'or isnull( C.Telefono ,'')= 'sin dato' then '' else ' - ' end)		 + 	    (case when isnull( C.Telefono ,'') = '' then '' else case when isnull( C.Telefono ,'')='Sin datos' or isnull( C.Telefono ,'')= 'sin datos'or isnull( C.Telefono ,'')= 'sin dato' then '' else C.Telefono  end end ) as telefono,  " &
                        " E.MT_nro_titulo,F.nombre AS MT_Tipo_Titulo,  " &
                        " E.MT_fec_expedicion_titulo, " &
                        " ISNULL(E.MT_fec_notificacion_titulo,'') AS MT_fec_notificacion_titulo, '' AS MT_for_notificacion_titulo , " &
                        " '$ '+substring (replace(CAST(CONVERT(varchar, CAST(E.totaldeuda  AS money), 1) AS varchar),',','.'),1,  LEN(CAST(E.totaldeuda  AS money))-1)as Total_Deuda, " &
                        " E.totaldeuda,                                                              " &
                        " CASE WHEN H.NOMBRE ='SIN DATOS'THEN '' ELSE H.NOMBRE END AS Departamento," &
                        " CASE WHEN I.NOMBRE ='SIN DATOS'THEN '' ELSE I.NOMBRE END AS Municipio, " &
                        " k.nombre as Proyecto, L.nombre as Revisor,ED_TipoPersona as DOCUMENTO, " &
                     " D.TIPO as Tipo_Deudor, c.idunico as IdDireccion, " &
                     " A.EFINUMMEMO,E.MT_fecha_ejecutoria,a.EFIFECHAEXP, F.codigo as codigotitulo " &
                     " FROM  EJEFISGLOBAL A,                " &
                      " ENTES_DEUDORES B,  DIRECCIONES C , " &
                      " DEUDORES_EXPEDIENTES D, MAESTRO_TITULOS E, " &
                      " TIPOS_TITULO F, TIPOS_IDENTIFICACION G, " &
                      " DEPARTAMENTOS H, MUNICIPIOS I, " &
                      " USUARIOS K, USUARIOS L " &
                      " WHERE A.EFINROEXP = D.NROEXP " &
                      " AND   D.DEUDOR = B.ED_Codigo_Nit " &
                      " AND   B.ED_Codigo_Nit = C.deudor  " &
                      " AND   E.MT_expediente = A.EFINROEXP " &
                    ...
                    Case Else
                        AdapterMT = New SqlClient.SqlDataAdapter(" SELECT  A.EFINROEXP AS MAN_EXPEDIENTE,																																																		" &
                                                               ...
                                                               " 	   L.nombre as Revisor,                                                                                                                                                                                                                 " &
                                                               " 	   D.TIPO as Tipo_Deudor,                                                                                                                                                                                                               " &
                                                               " 	   c.idunico as IdDireccion,A.EFINUMMEMO,E.MT_fecha_ejecutoria,A.EFIFECHAEXP, F.codigo as codigotitulo                                                                                                                                                       " &
                                                               " FROM  EJEFISGLOBAL A,                                                                                                                                                                                                                     " &
                                                               " 	  ENTES_DEUDORES B,                                                                                                                                                                                                                     " &
                                                               " 	  DIRECCIONES C ,                                                                                                                                                                                                                       " &
                                                               " 	  DEUDORES_EXPEDIENTES D,                                                                                                                                                                                                               " &
                ...
                Try
                    ...
                    If DtsDatos.DATOS_REPORTES.Rows.Count = 0 Then
                        Alert("  SE RECOMIENDA VERIFICAR LOS DATOS DE PARAMETRIACION " & vbNewLine &
                              "  NO SE ENCUENTRAN, " & vbNewLine &
                              "  DEBE VERIFICAR LA FECHA DE EXPEDICION DE TITULO, " & vbNewLine &
                              "  LA FECHA DE EJECUTORIA , Y SI POSEE EL TITULO EJECUTIVO " & vbNewLine &
                              "  EN LA PESTAÑA DE INFORMACION GENERAL " & vbNewLine &
                              "  EN LA PESTAÑA TITULO EJECUTIVO " & vbNewLine &
                              "  VERIFICAR QUE ESTE INGRESADO  LA FORMA DE NOTIFICACION " & vbNewLine &
                              "  DEL TITULO EN LA PESTAÑA INFORMACION GENERAL " & vbNewLine &
                              "  EN LA PESTAÑA TITULO EJECUTIVO " & vbNewLine &
                ...
                If selectcod = "230" Or selectcod = "368" Then
                    If DtsDatos.DATOS_REPORTES.Item(0).codigotitulo = "01" Then
                        ...
                        tbl2.Columns.AddRange(New DataColumn() {New DataColumn("SUBSISTEMA", GetType(String)),
                                                 New DataColumn("CAPITAL_1", GetType(String)),
                                                 New DataColumn("INTERESES_1", GetType(String)),
                                                 New DataColumn("TOTAL_A_PAGAR_1", GetType(String)),
                                                 New DataColumn("CAPITAL", GetType(Double)),
                                                 New DataColumn("INTERESES", GetType(Double)),
                ...
                If selectcod = "356" Then
                    ...
                    sql_deuda = New SqlCommand(" SELECT 0 AS CUENTA, " &
                                " ED_NOMBRE,ED_CODIGO_NIT + CASE WHEN ISNULL(ED_DIGITOVERIFICACION,'') ='' THEN '' ELSE '-' END +CASE WHEN ED_DIGITOVERIFICACION =''THEN '' ELSE ISNULL(ED_DIGITOVERIFICACION,'') END AS ED_CODIGO_NIT, " &
                                " PARTICIPACION FROM ENTES_DEUDORES ,DEUDORES_EXPEDIENTES  " &
                                " WHERE  NROEXP =@EXPEDIENTE AND TIPO ='2' " &
                    ...
                    sql_deuda2 = New SqlCommand(" SELECT 0 AS CUENTA, " &
                                " ED_NOMBRE,ED_CODIGO_NIT + CASE WHEN ISNULL(ED_DIGITOVERIFICACION,'') ='' THEN '' ELSE '-' END +CASE WHEN ED_DIGITOVERIFICACION =''THEN '' ELSE ISNULL(ED_DIGITOVERIFICACION,'') END AS ED_CODIGO_NIT, " &
                                " PARTICIPACION , '' AS VALORES,'' AS LETRAS  FROM ENTES_DEUDORES ,DEUDORES_EXPEDIENTES  " &
                                " WHERE  NROEXP =@EXPEDIENTE AND TIPO ='2' " &
                                " AND   DEUDOR = ED_CODIGO_NIT ", Ado)
                ...
                If selectcod = "318" Then
                    ...
                    End If
                    Dim tb1 As New DataTable
                    Dim sql_vinculo1 As SqlDataAdapter = New SqlDataAdapter(" SELECT ED_NOMBRE ," &
                                 " ED_CODIGO_NIT + CASE WHEN ISNULL(ED_DIGITOVERIFICACION,'') ='' THEN '' ELSE '-' END +CASE WHEN ED_DIGITOVERIFICACION =''THEN '' ELSE ISNULL(ED_DIGITOVERIFICACION,'') END AS ED_CODIGO_NIT " &
                                 " FROM ENTES_DEUDORES ,DEUDORES_EXPEDIENTES  " &
                                 " WHERE  NROEXP ='" & lblExpediente.Text.Trim & "' AND TIPO ='2' " &
                                 " AND   DEUDOR = ED_CODIGO_NIT ", Ado)
                    ...
                    If tbTitulo.Rows.Count > 0 Then
                        ...
                        If (tipoTitulo = "01") Or (tipoTitulo = "02") Or (tipoTitulo = "04") Then
                            ...
                            If dtsPlantilla.Rows.Count > 0 Then
                                ...
                                Dim ad As New SqlDataAdapter(" SELECT A.SUBSISTEMA,CONVERT(varchar(10), A.ANNO) + ' - '+  C.NOMBRE AS PERIODOS , CONVERT(varchar (50),convert(money, SUM(A.AJUSTE)),1) AS DEUDA FROM 																						" &
                                                            " 	(SELECT CONVERT(VARCHAR(12), EXPEDIENTE) + '' + SUBSISTEMA+ ''+ CONVERT(VARCHAR(50), NIT_EMPRESA)+ ''+ CONVERT(VARCHAR(4), ANNO)+ '' + CONVERT(VARCHAR(4),MES)+ ''+ CONVERT(VARCHAR(50),CEDULA) AS ID , * FROM DETALLE_FACILIDAD_PAGO ) A , " &
                                                            " 	(SELECT CONVERT(VARCHAR(12), EXPEDIENTE) + '' + SUBSISTEMA+ ''+ CONVERT(VARCHAR(50), NIT_EMPRESA)+ ''+ CONVERT(VARCHAR(4), ANNO)+ '' + CONVERT(VARCHAR(4),MES)+ ''+ CONVERT(VARCHAR(50),CEDULA) AS ID, * FROM SQL_PLANILLA )B,              " &
                                                            " 	 MAESTRO_MES C                                                                                                                                                                                                                              " &
                                                            " WHERE A.ID= B.ID                                                                                                                                                                                                                              " &
                                                            " AND A.MES=C.ID_MES AND B.MES=C.ID_MES  AND (A.AJUSTE > B.MONTO_PAGO)  AND A.EXPEDIENTE = @EXPEDIENTE                                                                                                                                              " &
                ...
                If selectcod = "363" Then
                    ...
                    sql_vinculo1 = New SqlDataAdapter(" SELECT 0 AS CUENTA ,ED_NOMBRE ," &
                                " ED_CODIGO_NIT + CASE WHEN ISNULL(ED_DIGITOVERIFICACION,'') ='' THEN '' ELSE '-' END +CASE WHEN ED_DIGITOVERIFICACION =''THEN '' ELSE ISNULL(ED_DIGITOVERIFICACION,'') END AS ED_CODIGO_NIT, " &
                                " PARTICIPACION FROM ENTES_DEUDORES ,DEUDORES_EXPEDIENTES  " &
                                " WHERE  NROEXP ='" & lblExpediente.Text.Trim & "' AND TIPO ='2' " &
                                " AND   DEUDOR = ED_CODIGO_NIT ", Ado)

                    sql_vinculo2 = New SqlDataAdapter(" SELECT 0 AS CUENTA ,ED_NOMBRE,  " &
                                " ED_CODIGO_NIT + CASE WHEN ISNULL(ED_DIGITOVERIFICACION,'') ='' THEN '' ELSE '-' END +CASE WHEN ED_DIGITOVERIFICACION =''THEN '' ELSE ISNULL(ED_DIGITOVERIFICACION,'') END AS ED_CODIGO_NIT, " &
                                " PARTICIPACION , '' AS VALORES ,'' AS LETRAS FROM ENTES_DEUDORES ,DEUDORES_EXPEDIENTES  " &
                                " WHERE  NROEXP ='" & lblExpediente.Text.Trim & "' AND TIPO ='2' " &
                                " AND   DEUDOR = ED_CODIGO_NIT ", Ado)
                ...
                End If
                'Resolucion de suspencion de proceso de proceso '

                If selectcod = "382" Or selectcod = "383" Then
                    Dim Parametros(7) As WordReport.Marcadores_Adicionales
                    Dim resolucion() As String
                    Dim apelacion() As String = Funciones.GET_RESOLUCION_APELACION(lblExpediente.Text.Trim)
                    resolucion = saveResolucion(lblExpediente.Text, selectcod)
                    SaveTable(lblExpediente.Text, selectcod)
                    resolucion = saveResolucion(lblExpediente.Text, selectcod)
                    Dim vc_datos() As String = overloadresolucion(lblExpediente.Text, selectcod)
                    ...
                    Parametros(2).Marcador = "letras"
                    Parametros(2).Valor = Num2Text(Mostrar_Saldo_Actual(lblExpediente.Text.Trim).ToUpper)

                    Parametros(3).Marcador = "total_deudas"
                    Parametros(3).Valor = Mostrar_Saldo_Actual(lblExpediente.Text.Trim)

                    Parametros(4).Marcador = "ESTADO_PROCESO"
                    Parametros(4).Valor = Funciones.GET_ESTADO_PROCESO(lblExpediente.Text.Trim).ToUpper

                    Parametros(5).Marcador = "resolucion_apelacion"
                    Parametros(5).Valor = apelacion(0)

                    Parametros(6).Marcador = "fecha_titulo"
                    Parametros(6).Valor = IIf(IsDBNull(DtsDatos.DATOS_REPORTES.Item(0).MT_fec_expedicion_titulo) = True, "", Funciones.getfecha_tipada(DtsDatos.DATOS_REPORTES.Item(0).MT_fec_expedicion_titulo))

                    Parametros(7).Marcador = "fecha_apelacion"
                    Parametros(7).Valor = apelacion(1)

                    ''Cambiar Estado a Suspendido
                    Cambiar_Estado_Suspendido(lblExpediente.Text.Trim)

                    worddocresult = worddoc.CreateReport(DtsDatos.DATOS_REPORTES, Reportes.Suspension_de_proceso, Parametros)
                    If worddocresult = "" Then
                        ''mensaje no informe
                    Else
        ...
        Try
            ...
            If DtsDatos.Mandaniento_Pago.Rows.Count > 0 Then
                ...
                If selectcod = "382" Or selectcod = "383" Then
                    ...
                    Parametros(0).Marcador = "Nro_Resolucion"
                    Parametros(0).Valor = "XXXXXXXXXX"

                    Parametros(1).Marcador = "fecha_actual"
                    Parametros(1).Valor = "XXXXXXXX"
    ...
    Private Function GetList_Emebargos(ByVal codigoActo As String, ByVal Expediente As String) As DataTable
        ...
        Dim cmd As New SqlClient.SqlCommand(
            " SELECT DISTINCT  A.DG_COD_ACTO,NRORESOLEM,FECRESOLEM " &
            " FROM DOCUMENTOS_GENERADOS A,EMBARGOS B     " &
            " WHERE A.DG_EXPEDIENTE  = B.NROEXP          " &
            " AND B.NROEXP =@EXPEDIENTE                  " &
