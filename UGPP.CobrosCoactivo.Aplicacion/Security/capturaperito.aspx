<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="capturaperito.aspx.vb" Inherits="coactivosyp.capturaperito" %>
    ...
    <h1 id="Titulo"><a href="#">Cobranzas</a></h1>
     ...
     <div class="Yup divhisto" 
         ...
         <table style="text-align:left; font-size:11px;" class = "ppala" align="center">
            <tr><td  class="cl">C.C del perito : </td><td class="cl2"><asp:TextBox ID="txtCedulanit" runat="server" style="text-align:center;"></asp:TextBox></td></tr>
            <tr><td  class="cl">Nombre del perito : </td><td class="cl2"><asp:TextBox ID="txtNomperito" runat="server" style="text-align:center;"></asp:TextBox></td></tr>
            <tr><td  class="cl">Fecha acogida : </td><td class="cl2"><asp:TextBox ID="txtFecDiligencia" runat="server" style="text-align:center;"></asp:TextBox></td></tr>
            <tr><td  class="cl">Valor avalúo: </td><td  class="cl2"><asp:TextBox ID="txtvalor" runat="server" style="text-align:center;"></asp:TextBox></td></tr>
         </table>
