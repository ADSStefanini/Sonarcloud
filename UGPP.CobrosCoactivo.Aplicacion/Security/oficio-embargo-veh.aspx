<%@ Page CodeBehind="oficio-embargo-veh.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="coactivosyp.oficio_embargo_veh" %>
		...
		<div id="wrap">
			...
			<div id="titulo-reporte">
				<div style="border: 1px solid black; width:600px;">
					OFICIO DE EMBARGO DE VEHICULO No.
			...
			<div id="contenido">
				<div id="contenido-texto">
					...
					E. S. D.
					<br /><br /><br /><br />
					Mediante la presente comunico  a Usted, que este Despacho por Resolución No. <% Response.Write(NumProceso) %>
					de fecha 30 de septiembre de 2002 ordenó el embargo del vehículo de placa 
