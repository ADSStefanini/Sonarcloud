        ...
        <form id="form1" runat="server">
           ...
           <div class="ws2" 
            ...
            <table style="position:absolute;left:91px; top:672px; z-index:1001;" 
                ...
                <tr>
                    <td>
                        <a id ="A11" href="Maestros/plantilla.aspx?pag=ConfiguracionInteresesSancion" runat="server"><img alt ="" src="imagenes/intereses.png" height="75" width="75" /></a>
                    </td>
                    <td>
                     <a id ="A12" href="Maestros/plantilla.aspx?pag=ConfiguracionIPC" runat="server"><img alt ="" src="imagenes/ipc.png" height="75" width="75" /></a>   
                    </td>
                    <td>
                        <a id ="A19" href="Maestros/plantilla.aspx?pag=PersuasivoTipificacion" runat="server"><img alt ="" src="imagenes/llamadas.png" height="75" width="75" /></a>
                    </td>
                    <td>
                        <a id ="A14" href="Maestros/plantilla.aspx?pag=ESTADOS_PAGO" runat="server"><img alt ="" src="imagenes/estado_final_pago.png" height="75" width="75" /></a>
                    </td>
                </tr>
                <!-- Fila de etiquetas -->
                <tr>
                  <td>Configuración interes sanción</td>
                  <td>Configuración IPC</td>
                  <td>Tipificación de llamadas</td>
                  <td>Estado final pago - Persuasivo</td>
                </tr>
                
                <!-- Fila de imagenes -->
                <tr>
                    <td>
                        <a id ="A21" href="Maestros/plantilla.aspx?pag=RESULTCOBROCALLCENTER" runat="server"><img alt ="" src="imagenes/resultado_cobro.png" height="75" width="75" /></a>
                    </td>
                    <td>
                     <a id ="A17" href="Maestros/plantilla.aspx?pag=CRITERIOS_MEDIDAS_CAUTELARES" runat="server"><img alt ="" src="imagenes/resultado_cobro.png" height="75" width="75" /></a>
                    </td>
                    <td>
                     <a id ="A18" href="Maestros/plantilla.aspx?pag=ConfiguracionDTF" runat="server"><img alt ="" src="imagenes/aportes.png" height="75" width="75" /></a>   
                    </td>
                    <td>
                ...
                <!-- Fila de etiquetas -->
                <tr>
                  <td>Resultado acciones persuasivas</td>
                  <td>Criterios para ordenar Medidas Cautelares </td>
                  <td>Configuración DTF</td>
                  <td></td>
                </tr>
