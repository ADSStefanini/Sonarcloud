    ...
    <head id="Head1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function selectTipo(sel) {
                if (sel.value == "01") {
                     //$("#cboED_EstadoPersona").show()
                     $("#txtNoMatricula").hide()
                } else {
                    //$("#cboED_EstadoPersona").hide()
                    //$("#cboED_EstadoPersona").val("00")
                    $("#txtNoMatricula").show()
                }
    ...
    <body>
        <form id="form1" runat="server">        	
        	<div id="tabs">
                ...
                <div id="tabs-1">
                    <asp:Panel ID="pnlDatosDeudor" runat="server">
                        <table id="tblEditENTES_DEUDORES" class="ui-widget-content" runat="server">
                         <tr>
                            <td>&nbsp;
                            ...
                            <td>
                                <asp:DropDownList CssClass="ui-widget" id="cboED_TipoPersona" runat="server" width="270px" onchange="selectTipo(this)" ClientIDMode="Static"></asp:DropDownList>
                            </td>
                        </tr>  
                        <tr>
                            <td>&nbsp;
                         ...
                         <tr>
                            ...
                            <td class="style3">
                                <asp:Label ID="lblNumeroMatricula" runat="server" 
                                    Text="Matricula Mercantil "></asp:Label>
                            </td>
                            <td class="style2">
                                <asp:TextBox id="txtNoMatricula" runat="server" MaxLength="100" Columns="80" 
                        ...
                        <tr>
                          ...
                          <tr>
                            ...
                            <td class="style3">
                                <asp:Label ID="lblTarjetaProf" runat="server" Text="Tarjeta profesional " style="display: none;"></asp:Label>
                            </td>
                            <td class="style2">
                                <asp:TextBox id="txtTarjetaProf" runat="server" MaxLength="100" Columns="80" CssClass="numeros" style="display: none;"></asp:TextBox>
                            </td>
                              </tr>
                        <tr>
                            <td class="style2">
                ...
                <div id="tabs-2">
                    ...
                    <div style="margin-left:2px; margin-top:4px; width:860px; height:740px;">                                                            	
						<iframe src="direcciones.aspx?ID_TASK=<%  Response.Write(Request("ID_TASK"))%>&IdDeudor=<%  Response.Write(Request("IdDeudor"))%>" width="860" height="740" scrolling="no" frameborder="0"></iframe>								
					</div>                    
                    <!-- ----------------------------------------------------------------------------- -->
                </div>
			</div>  
