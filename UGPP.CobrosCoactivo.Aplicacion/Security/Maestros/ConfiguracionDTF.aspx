<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ConfiguracionDTF.aspx.vb"
    Inherits="coactivosyp.Security.Maestros.ConfiguracionDTF" %>
...
<body>
    ...
    <div id="tabs">
        <ul>
            <li><a href="#tabs-1">Configurar DTF</a></li>
        </ul>
        <div id="tabs-1">
            <table>
                <tr>
                    <td align="left">
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td class="style1">
                                    <asp:TextBox ID="txtSearchperiodo" runat="server"></asp:TextBox>
                                </td>
                                <td class="style2">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" CssClass="PCG-Content"
                            ...
                            <Columns>
                                <asp:BoundField DataField="PERIODO" HeaderText="PERIODO" SortExpression="DTF.PERIODO">
                                    <ItemStyle HorizontalAlign="Center" Height="20px" Width="100px" />
                                    <HeaderStyle CssClass="BoundFieldHeaderStyleHidden" />
                                </asp:BoundField>
                                <asp:BoundField DataField="DTF" HeaderText="DTF" SortExpression="DTF.DTF">
                                    <ItemStyle HorizontalAlign="Center" Height="20px" Width="100px" />
                                </asp:BoundField>
