...
Partial Public Class EditENTES_DEUDORES_E
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            'Se desactiva la edición del deudor si es un perfil diferente al área origen
    ...
    Private Sub MostrarDeudor(ByVal pDeudor As String)
        ...
        Dim sql As String = "SELECT entes_deudores.*, deudores_expedientes.tipo,deudores_expedientes.participacion 				" &
                            "	FROM entes_deudores LEFT JOIN deudores_expedientes 				" &
                            "	ON entes_deudores.ED_Codigo_Nit = deudores_expedientes.deudor	" &
        ...
        If Reader.Read Then
            ...
            txtNoMatricula.Text = Reader("VAL_NO_MATRICULA_MERCANTIL").ToString()
    ...
    Protected Sub cmdBorrar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdBorrar.Click
        Response.Redirect("BorrarDEUDORES_EXPEDIENTES_E.aspx?pExpediente=" & Request("pExpediente") & "&pDeudor=" & Request("ID") & "&pScr=" & Request("pScr") & "&pTipo=" & Request("pTipo") & "&pNombre=" & txtED_Nombre.Text.Trim)
    End Sub
