<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EditENTES_DEUDORES_E.aspx.vb" Inherits="coactivosyp.EditENTES_DEUDORES_E" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Maestro de Deudores
        </title>
...
<body>
    <form id="form1" runat="server">
        <div id="tabs">
            <ul>
                <li><a href="#tabs-1">
                    <asp:Label ID="lblPage1" runat="server" Text="Información gral"></asp:Label></a></li>
            ...
            <div id="tabs-1">
                <table id="tblEditENTES_DEUDORES" class="ui-widget-content">
                    <tr>
                        ...
                        <td class="style4">Tipo de persona *
                            </td>
                        <td>
                   ...
                   <tr>
                        ...
                        <td class="style4">Estado persona *
                            </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="style4">No. de identificación *
                            </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="style4">Dígito de verificación.
                            </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="style4">Tipo Identificación
                            </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="style4">Nombre / Razón social *
                            </td>
                        <td>
            ...
            <div id="tabs-2">
                ...
                <div style="margin-left: 2px; margin-top: 4px; width: 860px; height: 740px;">
                    <iframe src="direcciones_E.aspx?ID=<%  Response.Write(Request("ID"))%>&pExpediente=<%  Response.Write(Request("pExpediente"))%>" width="860" height="740" scrolling="no" frameborder="0"></iframe>
                </div>
                <!-- ----------------------------------------------------------------------------- -->
            </div>
        </div>
