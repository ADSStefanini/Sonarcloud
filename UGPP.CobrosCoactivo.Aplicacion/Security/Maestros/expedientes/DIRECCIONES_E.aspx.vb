...
Partial Public Class DIRECCIONES_E
    ...
    Private Sub BindGrid()
        If Len(Request("ID")) > 0 Then
            ...
            Connection.Open()
            Dim sql As String = "select DIRECCIONES.*, DEPARTAMENTOSDepartamento.nombre as DEPARTAMENTOSDepartamentonombre, " &
                    "MUNICIPIOSCiudad.nombre as MUNICIPIOSCiudadnombre from (DIRECCIONES " &
                    "left join [DEPARTAMENTOS] DEPARTAMENTOSDepartamento on [dbo].[DIRECCIONES].Departamento = DEPARTAMENTOSDepartamento.codigo )  " &
                    "left join [MUNICIPIOS] MUNICIPIOSCiudad on [dbo].[DIRECCIONES].Ciudad = MUNICIPIOSCiudad.codigo " &
    ...
    Protected Sub cmdAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdAddNew.Click
        ...
        Response.Redirect("EditDIRECCIONES_E.aspx?ID=" & Request("ID") & "&pExpediente=" & Request("pExpediente"))
    End Sub
    ...
    Protected Sub grd_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grd.RowCommand
        If e.CommandName = "" Then
            ...
            Response.Redirect("EditDIRECCIONES_E.aspx?ID=" & deudor & "&pIdUnico=" & Iddireccion & "&pExpediente=" & Request("pExpediente"))
        End If
    End Sub
End Class