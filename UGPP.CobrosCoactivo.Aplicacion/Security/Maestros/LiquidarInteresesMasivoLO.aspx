<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LiquidarInteresesMasivoLO.aspx.vb"
    Inherits="coactivosyp.LiquidarInteresesMasivoLO" %>
    ...
    <table id="Table1" cellspacing="0" cellpadding="0" width="78%" border="0" class="ui-widget-content ui-widget">
        <tr>
            <td class="ui-state-hover" style="text-align: center; font-size: medium;" colspan="2">
                <span lang="es">PANTALLA PARA EL CÁLCULO DE INTERESES L.O.</span>
            </td>
        </tr>
        <tr>
            <td>
