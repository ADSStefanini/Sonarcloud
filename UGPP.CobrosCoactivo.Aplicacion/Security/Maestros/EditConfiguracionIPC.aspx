<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EditConfiguracionIPC.aspx.vb"
    Inherits="coactivosyp.Security.Maestros.EditConfiguracionIPC" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Editar configuracion de IPC </title>
...
<body>
    ...
    <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0" class="ui-widget-content ui-widget">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtanio" runat="server" CssClass="ui-widget"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <asp:TextBox ID="txttasa" runat="server" CssClass="ui-widget"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
