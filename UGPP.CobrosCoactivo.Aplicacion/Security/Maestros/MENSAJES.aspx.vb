...
Partial Public Class MENSAJES
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            If Session("mnivelacces") = CInt(Enumeraciones.Roles.VERIFICADORPAGOS) Then
                'Se inhabilita el botón Crear mensaje para este perfil
                cmdAddNew.Enabled = False
            Else
                'Se habilita el botón Crear mensaje para usuarios con perfil diferente a Verificador de Pagos
    ...
    Private Function GetSQL() As String
        ...
        Dim Columns As String = "MENSAJES.idunico, MENSAJES.NroExp, MENSAJES.UsuOrigen, MENSAJES.UsuDestino, MENSAJES.Mensaje, " &
                                "MENSAJES.FecEnvio, MENSAJES.FecRecibo, CASE leido WHEN 1 THEN 'SI' ELSE 'NO' END AS leido, " &
                                "USUARIOSUsuOrigen.nombre as USUARIOSUsuOrigennombre, USUARIOSUsuDestino.nombre as USUARIOSUsuDestinonombre"

        Dim Table As String = "([MENSAJES] left join [USUARIOS] USUARIOSUsuOrigen on [dbo].[MENSAJES].UsuOrigen = USUARIOSUsuOrigen.codigo )  " &
    ...
    Protected Sub grd_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grd.RowCommand
        'Se inhabilita la opción de leer para usuarios con perfil Verificador de Pagos
        If Session("mnivelacces") <> CInt(Enumeraciones.Roles.VERIFICADORPAGOS) Then
