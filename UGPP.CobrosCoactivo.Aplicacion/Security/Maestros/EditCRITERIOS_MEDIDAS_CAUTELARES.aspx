<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EditCRITERIOS_MEDIDAS_CAUTELARES.aspx.vb" Inherits="coactivosyp.EditCRITERIOS_MEDIDAS_CAUTELARES" %>
        ...
        <form id="form1" runat="server">
            <table id="tblEditTIPOS_TITULO" class="ui-widget-content">
                <tr>
                    ...
                    <td>
                        <asp:TextBox id="txtcodigo" runat="server" ReadOnly="true" CssClass="ui-widget"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox id="txtnombre" runat="server" MaxLength="100" Width="200px" CssClass="ui-widget"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
