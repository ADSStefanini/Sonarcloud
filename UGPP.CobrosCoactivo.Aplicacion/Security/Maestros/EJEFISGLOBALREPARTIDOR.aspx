        ...
        <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0" class="ui-widget-content ui-widget">
            <tr>
                <td colspan="10" background="images/resultados_busca.jpg" height="42">
                    ...
                    <%-- Jeisson Gómez 
                            HU_009 Reporte General de Actuaciones 
                            Fecha: 06/06/2017
                            Se habilta el ícono de reportes para el perfil Gestor de Información  --%>
                ...
                <td align="right">
                    ...
                    <div id="divFiltros">
                        <table style="width: 100%">
                            ...
                            <tr>
                                <td class="ui-widget-header">C.C. / NIT deudor
                                </td>
                                <td>
                                    <asp:TextBox ID="txtSearchEFINIT" runat="server" Columns="20"></asp:TextBox>
                                </td>
                                <td class="ui-widget-header">Nombre
                                </td>
                                <td>
                                ...
                                <td>
                                    <asp:Button ID="btnEstadoGestion" runat="server" Text="Ver Estado Gestión" CssClass="PCGButton head-btn"></asp:Button>
                                </td>
                            </tr>
                            <tr>
                                <td class="ui-widget-header">Estado
                                </td>
                                <td>
                                ...
                                <td class="ui-widget-header">Gestor / Abogado
                                </td>
                                <td>
                                ...
                                <td>
                                    <asp:Button ID="btnInformes" runat="server" Text="Informes" CssClass="head-btn" />
                                </td>
                            </tr>
                            <tr>
                                <td class="ui-widget-header">Alerta / Término
                                </td>
                                <td>
                                    <asp:TextBox ID="txtTermino" runat="server" Columns="20" Enabled="false" Visible="false"></asp:TextBox>
                                    <%-- Jeisson Gómez 
                                                Revertir la HU_003 07/03/2017
                                                ' La línea de txtTermino así estaba antes del cambio.
                                                <asp:TextBox ID="txtTermino" runat="server" Columns="20" Enabled="false" Visible="false" ></asp:TextBox>--%>
                                ...
                                <td>
                                    <asp:Button ID="btnClasificacionAutoCartera" runat="server" Text="Clasificación Autom Cartera" CssClass="head-btn" />
                                </td>
                                <td>
                                    <asp:Button ID="btnRepartoAuto" runat="server" Text="Reparto Automático" CssClass="head-btn" />
                                </td>
                            </tr>
                        </table>
                    </div>
