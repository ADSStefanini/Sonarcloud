...
Partial Public Class EJEFISGLOBAL_MASIVO
    ...
    Private Function GetSQL() As String
        ...
        Dim Columns As String = "EJEFISGLOBAL.EFINROEXP,  EJEFISGLOBAL.EFIFECHAEXP, EJEFISGLOBAL.EFINIT, EJEFISGLOBAL.EFIFECENTGES," &
                                    "EJEFISGLOBAL.EFIFECCAD, EJEFISGLOBAL.EFIVALDEU , EJEFISGLOBAL.EFIPAGOSCAP, EJEFISGLOBAL.EFISALDOCAP, " &
                                    "ESTADOS_PROCESO.nombre AS EFIESTADO, ESTADOS_PAGO.nombre AS EFIESTUP, PERSUASIVO.FecEstiFin, " &
                                    "ENTES_DEUDORES.ED_NOMBRE, " &
                                    "'OK' AS termino,'      ' AS explicacion,'                    ' AS PictureURL," &
                                    "COALESCE(TITULOSEJECUTIVOS.NomTipoTitulo,'') AS NomTipoTitulo "

        Dim Table As String = "EJEFISGLOBAL LEFT JOIN ESTADOS_PROCESO ON EJEFISGLOBAL.EFIESTADO = ESTADOS_PROCESO.codigo " &
