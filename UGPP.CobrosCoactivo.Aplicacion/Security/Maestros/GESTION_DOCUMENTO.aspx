<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GESTION_DOCUMENTO.aspx.vb" Inherits="coactivosyp.GESTION_DOCUMENTO" %>
...
<body class="internal">
    <form id="form1" runat="server">
        ...
        <div id="data">
            <asp:GridView ID="gwDocumento" runat="server"  DataKeyNames="ID_DOCUMENTO_TITULO,COD_TIPO_TITULO"
                AutoGenerateColumns="False" CssClass="PCG-Content list tbl-indentation" AllowSorting="True">
                <Columns>                   
                    <asp:BoundField DataField="NOMBRE_DOCUMENTO_TITULO" HeaderText="Nombre Documento">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="NOMBRE_TIPO_TITULO" HeaderText="Nombre Tipo">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:CheckBoxField DataField="VAL_ESTADO" HeaderText="Estado">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:CheckBoxField>
                    <asp:CheckBoxField DataField="VAL_OBLIGATORIO" HeaderText="Obligatorio">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:CheckBoxField>
