...
Partial Public Class SOLICITUDCAMBIOESTADO
    ...
    Private Function GetSQL() As String
        ...
        If NomPerfil = "REPARTIDOR" Then
            WhereClause = WhereClause & " and nivel_escalamiento = 3  and accion = 'PENDIENTE'"
        ...
        ElseIf NomPerfil = "REVISOR" Then
            ...
            WhereClause = WhereClause & " and revisor = '" & Session("sscodigousuario") & "' and accion = 'PENDIENTE'"

        Else
            'NomPerfil = "SUPERVISOR"
            WhereClause = WhereClause & " and nivel_escalamiento = 2  and accion = 'PENDIENTE'"
