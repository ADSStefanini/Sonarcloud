...
Partial Class EditPERSUASIVOOBSERVACIONES
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If IsPostBack = False Then
            ...
            If Len(Request("ID")) > 0 Then
                Dim sql As String = "SELECT * FROM PERSUASIVOOBSERVACIONES WHERE IdUnico = @IdUnico"
    ...
    Protected Sub cmdDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        ...
        Dim sql As String = "DELETE FROM PERSUASIVOOBSERVACIONES WHERE IdUnico = @IdUnico"
        Dim Command As New SqlCommand(sql, Connection)
        Command.Parameters.AddWithValue("@IdUnico", Request("ID"))
        Command.ExecuteNonQuery()

        Connection.Close()
        Response.Redirect("PERSUASIVOOBSERVACIONES.aspx?pExpediente=" & Request("pExpediente").Trim)
    End Sub
    ...
    Private Overloads Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Dim InsertSQL As String = "INSERT INTO PERSUASIVOOBSERVACIONES ([NroExp], [Fecha], [gestor], [observaciones] ) VALUES ( @NroExp, @Fecha, @gestor, @observaciones ) "
        Dim UpdateSQL As String = "UPDATE PERSUASIVOOBSERVACIONES SET NroExp = @NroExp, Fecha = @Fecha, gestor = @gestor, observaciones = @observaciones where IdUnico = @IdUnico "
