<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EditConfiguracionInteresesSancion.aspx.vb" Inherits="coactivosyp.Security.Maestros.EditConfiguracionInteresesSancion " %>
        ...
        <table class="ui-widget-content ui-widget">
                ...
                <tr>
                    ...
                    <td class="ui-widget-header">
                        Tasa anual</td>
                    <td>
                        <asp:TextBox id="txtpanual" runat="server" CssClass="ui-widget" AutoPostBack="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox id="txtpmensual" runat="server" CssClass="ui-widget" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
