<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DEPARTAMENTOS.aspx.vb" Inherits="coactivosyp.DEPARTAMENTOS" %>
                                ...
                                <td>
                                    <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" CssClass="PCG-Content" AllowPaging="true" AllowSorting="true">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="codigo" HeaderText="Código" SortExpression="DEPARTAMENTOS.codigo"></asp:BoundField>
                                            <asp:BoundField DataField="nombre" HeaderText="Nombre" SortExpression="DEPARTAMENTOS.nombre"></asp:BoundField>
                        ...
                        <div class="hidden">
                            <div id="dialog" title="Actualizar">
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
                                    <ContentTemplate>
                                        <table id="tblEditDialogDEPARTAMENTOS" class="ui-widget-content">
                                            <tr>
                                                <td>
                                                    &nbsp;
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox id="txtDialognombre" runat="server" MaxLength="100" CssClass="ui-widget"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
                            ...
                            <asp:Button ID="cmdDelete" Text="Borrar" runat="server" />
