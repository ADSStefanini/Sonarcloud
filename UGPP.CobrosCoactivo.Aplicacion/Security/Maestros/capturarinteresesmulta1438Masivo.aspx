<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="capturarinteresesmulta1438Masivo.aspx.vb"
    Inherits="coactivosyp.capturarinteresesmulta1438Masivo" %>
    ...
    <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0" class="ui-widget-content ui-widget">
        <tr>
            ...
            <td class="ui-state-hover" style="text-align: center; font-size: medium;" colspan="2">
                <span lang="es">PANTALLA EL CÁLCULO DE INTERES MULTAS 1438</span>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                Buscar :  <input id="txtbuscar" type="text" /> 
