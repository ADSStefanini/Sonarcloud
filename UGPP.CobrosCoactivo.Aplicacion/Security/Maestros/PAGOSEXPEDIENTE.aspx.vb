...
Partial Public Class PAGOSEXPEDIENTE
    ...
    Protected Sub grd_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grd.RowCommand
        If e.CommandName = "" Then
            ...
            If NomPerfil = "VERIFICADOR DE PAGOS" Then
                Response.Redirect("EditPAGOS.aspx?ID=" & NroConsignacion & "&pExpediente=" & Request("pExpediente"))
            Else
    ...
    Protected Sub cmdAdicionar_Click(sender As Object, e As EventArgs) Handles cmdAdicionar.Click
        Dim tipo As String = _TipoTitulo(Request("pExpediente"))
        If tipo = "08" Then
            Response.Redirect("EditPAGOSLiquidacionSancion.aspx?tab=1&pExpediente=" & Request("pExpediente"))
        Else
