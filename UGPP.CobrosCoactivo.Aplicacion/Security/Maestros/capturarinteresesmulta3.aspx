<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="capturarinteresesmulta3.aspx.vb" Inherits="coactivosyp.capturarinteresesmulta3" %>
    ...
    <form id="form1" runat="server">
           <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0" class="ui-widget-content ui-widget">
            ...
            <td class="ui-state-hover" 
                        ...
                        <span lang="es">PANTALLA EL CÁLCULO DE INTERESES DE MULTAS 1438.</span></td>
