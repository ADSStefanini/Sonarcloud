<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EditConfiguracionInteresesParafiscales.aspx.vb" Inherits="coactivosyp.Security.Maestros.EditConfiguracionInteresesParafiscales" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    <head id="Head1" runat="server">
        <title>
            Editar configuracion de intereses parafiscales
        </title>
    ...
    <body>
        ...
        <table class="ui-widget-content ui-widget">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox id="txtptrimestral" runat="server" CssClass="ui-widget" AutoPostBack="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox id="txtdesde" runat="server" CssClass="ui-widget"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox id="txthasta" runat="server" CssClass="ui-widget"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox id="txttdiaria" runat="server" CssClass="ui-widget" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
