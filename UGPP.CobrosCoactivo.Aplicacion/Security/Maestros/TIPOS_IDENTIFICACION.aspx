<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TIPOS_IDENTIFICACION.aspx.vb" Inherits="coactivosyp.TIPOS_IDENTIFICACION" %>
                                ...
                                <td>
                                    <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" CssClass="PCG-Content" AllowPaging="true" AllowSorting="true">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="codigo" HeaderText="Código" SortExpression="TIPOS_IDENTIFICACION.codigo"></asp:BoundField>
                                            <asp:BoundField DataField="nombre" HeaderText="Nombre" SortExpression="TIPOS_IDENTIFICACION.nombre"></asp:BoundField>
                        ...
                        <div class="hidden">
                            <div id="dialog" title="Actualizar">
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
                                    <ContentTemplate>
                                        <table id="tblEditDialogTIPOS_IDENTIFICACION" class="ui-widget-content">
                                            <tr>
                                                <td>
                                                    &nbsp;
                                                </td>
