<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PROMOTORES.aspx.vb" Inherits="coactivosyp.PROMOTORES" %>
            ...
            <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0" class="ui-widget-content ui-widget">
                <tr>
                    <td align="right">
                            ...
                            Cédula</td>
                            <td>
                            <asp:TextBox ID="txtSearchcedula" runat="server" ></asp:TextBox></td>
                        <td class="ui-widget-header">
                        Nombre</td>
                        <td>
