<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="capturarinteresesmulta.aspx.vb"
    Inherits="coactivosyp.capturarinteresesmulta" %>
...
<body>
    ...
    <table id="Table1" align="center" cellspacing="0" cellpadding="0" width="78%" border="0" class="ui-widget-content ui-widget">
        <tr>
            <td class="ui-state-hover" style="text-align: center; font-size: medium;" colspan="2">
                <span lang="es">PANTALLA EL CÁLCULO DE IPC DE SANCIÓN 1607 Y LIQUIDACIÓN OFICIAL / SANCIÓN - SÓLO LA PARTE DE SANCIÓN</span>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td colspan="2" align="center">
                <div style="overflow-y: scroll; height: 450px; width: 1200px">
                    <asp:GridView ID="grdExpe" Width="1000px" runat="server" AutoGenerateColumns="False" CssClass="PCG-Content filtrar">
                        <Columns>
                            ...
                            <asp:BoundField DataField="NOMBRETITULO" HeaderText ="TITULO" ItemStyle-Width="200px"></asp:BoundField>
                            <asp:BoundField DataField="EFIVALDEU" HeaderText="DEUDA" DataFormatString="{0:N2}" ItemStyle-HorizontalAlign="Right"></asp:BoundField>
