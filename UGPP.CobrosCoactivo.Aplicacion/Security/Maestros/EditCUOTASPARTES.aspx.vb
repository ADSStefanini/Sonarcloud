    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            If Session("mnivelacces") = CInt(Enumeraciones.Roles.VERIFICADORPAGOS) Then
                ...
                cboEstadoEnte.Enabled = False
                txtFechaLey550.Enabled = False
                imgBtnBorraFecLey550.Enabled = False
                txtFechaOfiConsulta.Enabled = False
                imgBtnBorraFecOfiConsulta.Enabled = False
                txtFecReciOfiConsul.Enabled = False
                imgBtnBorraFecReciOfiConsul.Enabled = False
                txtFechaEscritoObj.Enabled = False
                imgBtnBorraFecescritoObj.Enabled = False
                txtFechaAcepCP.Enabled = False
                imgBtnBorraFechaAcepCP.Enabled = False
                txtFechaFormalSilPos.Enabled = False
                imgBtnBorraFechaFormalSilPos.Enabled = False
                txtFechaDocResObj.Enabled = False
                imgBtnBorraFechaDocResObj.Enabled = False
                txtNoResolCP.Enabled = False
                txtFecResolCP.Enabled = False
                imgBtnBorraFecResolCP.Enabled = False
                txtNoCuentaCobro.Enabled = False
                txtFechaCuentaCobro.Enabled = False
                imgBtnBorraFechaCuentaCobro.Enabled = False
                txtFecEntregaCtaCobro.Enabled = False
                imgBtnBorraFecEntregaCtaCobro.Enabled = False
                txtObservaciones.Enabled = False
                txtObservaciones.Enabled = False
                cmdSave.Enabled = False
                cmdEditPensionados.Enabled = False
            Else
                'Se habilitan los campos para usuarios con perfil diferente a Verificador de Pagos
                cboEstadoEnte.Enabled = True
                txtFechaLey550.Enabled = True
                imgBtnBorraFecLey550.Enabled = True
                txtFechaOfiConsulta.Enabled = True
                imgBtnBorraFecOfiConsulta.Enabled = True
                txtFecReciOfiConsul.Enabled = True
                imgBtnBorraFecReciOfiConsul.Enabled = True
                txtFechaEscritoObj.Enabled = True
                imgBtnBorraFecescritoObj.Enabled = True
                txtFechaAcepCP.Enabled = True
                imgBtnBorraFechaAcepCP.Enabled = True
                txtFechaFormalSilPos.Enabled = True
                imgBtnBorraFechaFormalSilPos.Enabled = True
                txtFechaDocResObj.Enabled = True
                imgBtnBorraFechaDocResObj.Enabled = True
                txtNoResolCP.Enabled = True
                txtFecResolCP.Enabled = True
                imgBtnBorraFecResolCP.Enabled = True
                txtNoCuentaCobro.Enabled = True
                txtFechaCuentaCobro.Enabled = True
                imgBtnBorraFechaCuentaCobro.Enabled = True
                txtFecEntregaCtaCobro.Enabled = True
                imgBtnBorraFecEntregaCtaCobro.Enabled = True
                txtObservaciones.Enabled = True
                txtObservaciones.Enabled = True
                cmdSave.Enabled = True
                cmdEditPensionados.Enabled = True
            End If
