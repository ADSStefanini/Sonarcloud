...
Partial Public Class EJEFISGLOBALREPARTIDOR
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            ' Jeisson Gómez 
            ' 12/01/2017
            'Carga los elementos desde la tabla ALARMAS campo nombre a ser buscados 
    ...
    Private Sub ContarSolicitudesCambioEstado()
        ...
        Connection.Open()
        Dim sql As String = "SELECT COUNT(*) AS NumSol  FROM SOLICITUDCAMBIOESTADO WHERE nivel_escalamiento = 3 and accion != 'REALIZADO'"
    ...
    Private Sub BindGrid()
        ...
        ' Jeisson Gómez 
        ' Cambio el filtro del objeto txtTermino a cboSearchTERMINO
        ' dtProcesos2 = FiltrarDataTable(dtProcesos, "termino LIKE '%" & txtTermino.Text.Trim & "%'", SortOrder)
        ' Jeisson Gómez 
        ' Se revierte el cambio 07/03/2017 
        ' Se pasa el HU_003 y se vuelve a dejar este filtro.
        If cboSearchTERMINO.SelectedItem.Value = "00" Then
            dtProcesos2 = FiltrarDataTable(dtProcesos, "termino = termino", SortOrder)
        Else
            dtProcesos2 = FiltrarDataTable(dtProcesos, "termino LIKE '%" & cboSearchTERMINO.SelectedItem.Text.Trim & "%'", SortOrder)
        End If
    ...
    Protected Sub LoadcboSearchTERMINO()
        ...
        'Dim Connection As New SqlConnection(Funciones.CadenaConexion)
        'Connection.Open()
        'Dim sql As String = "SELECT CODIGO, NOMBRE FROM ALARMAS ORDER BY NOMBRE"
        'Dim Command As New SqlCommand(sql, Connection)

        'cboSearchTERMINO.DataTextField = "nombre"
        'cboSearchTERMINO.DataValueField = "codigo"
        'cboSearchTERMINO.DataSource = Command.ExecuteReader()
