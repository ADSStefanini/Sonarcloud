<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MAESTRO_DEUDORSOLIDARIO.aspx.vb" Inherits="coactivosyp.MAESTRO_DEUDORSOLIDARIO" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
    <head>
        <title>MAESTRO_DEUDORSOLIDARIO</title>
            ...
            <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0" class="ui-widget-content ui-widget">
                <tr>
                    <td align="right">
                            ...
                            <td>
                            <asp:TextBox ID="txtSearchMDS_Codigo_Nit" runat="server" ></asp:TextBox></td>
                        <td class="ui-widget-header">
                        Nombre</td>
                        <td>
                        <asp:TextBox ID="txtSearchMDS_Nombre" runat="server" ></asp:TextBox></td>
                                                <td>                                                    
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" CssClass="PCG-Content" AllowSorting="true">
                                            <Columns>
                                                <asp:BoundField DataField="MDS_Codigo_Nit" >
                                                    <ItemStyle CssClass="BoundFieldItemStyleHidden" />
                                                    <HeaderStyle CssClass="BoundFieldHeaderStyleHidden" />            
                                                </asp:BoundField>
                                                <asp:BoundField DataField="MDS_Codigo_Nit" HeaderText="No. identificación" SortExpression="MAESTRO_DEUDORSOLIDARIO.MDS_Codigo_Nit"></asp:BoundField>
                                                <asp:BoundField DataField="MDS_DigitoVerificacion" HeaderText="D. Verif." SortExpression="MAESTRO_DEUDORSOLIDARIO.MDS_DigitoVerificacion"></asp:BoundField>
                                                <asp:BoundField DataField="MDS_Nombre" HeaderText="Nombre" SortExpression="MAESTRO_DEUDORSOLIDARIO.MDS_Nombre"></asp:BoundField>
