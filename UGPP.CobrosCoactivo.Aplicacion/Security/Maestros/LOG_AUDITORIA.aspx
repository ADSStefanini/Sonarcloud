                        ...
                        <tr>
                            <td align="right">
                                <table style="width: 100%">
                                    <tr>
                                        <td class="ui-widget-header">ID de usuario</td>
                                        <td>
                                            <asp:TextBox ID="txtSearchLOG_USER_ID" runat="server"></asp:TextBox></td>
                                        <td class="ui-widget-header">Host / Equipo</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="ui-widget-header">IP</td>
                                        <td>
                                            <asp:TextBox ID="txtSearchLOG_IP" runat="server"></asp:TextBox></td>
                                        <td class="ui-widget-header">Módulo</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="ui-widget-header">Documento afectado
                                        </td>
                                        <td>
                            ...
                            <td>
                                ...
                                <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" CssClass="PCG-Content" AllowSorting="true">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="LOG_NEGOCIO" HeaderText="Negocio" SortExpression="LOG_AUDITORIA.LOG_NEGOCIO"></asp:BoundField>
                                    </Columns>
