<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TIPOS_APORTANTES.aspx.vb" Inherits="coactivosyp.TIPOS_APORTANTES" %>

<html>
    <head>
        <title>TIPOS_APORTANTES</title>
                                ...
                                <td>
                                    <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" CssClass="PCG-Content" AllowPaging="true" AllowSorting="true">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="codigo" HeaderText="Código" SortExpression="TIPOS_APORTANTES.codigo"></asp:BoundField>
                                            <asp:BoundField DataField="nombre" HeaderText="Nombre" SortExpression="TIPOS_APORTANTES.nombre"></asp:BoundField>
                        ...
                        <div class="hidden">
                            <div id="dialog" title="Actualizar">
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
                                    <ContentTemplate>
                                        <table id="tblEditDialogTIPOS_APORTANTES" class="ui-widget-content">
                                            <tr>
                                                <td>
                                                    &nbsp;
                                                </td>
