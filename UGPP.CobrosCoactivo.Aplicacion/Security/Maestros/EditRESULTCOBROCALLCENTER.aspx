<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EditRESULTCOBROCALLCENTER.aspx.vb" Inherits="coactivosyp.EditRESULTCOBROCALLCENTER" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    <head id="Head1" runat="server">
        <title>
            Editar RESULTADO COBRO EN CALLCENTER
        </title>
    ...
    <body>
        <form id="form1" runat="server">
            <table id="tblEditRESULTCOBROCALLCENTER" class="ui-widget-content">
                <tr>
                    <td>
                        &nbsp;
                    </td>
