<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CRITERIOS_MEDIDAS_CAUTELARES.aspx.vb" Inherits="coactivosyp.CRITERIOS_MEDIDAS_CAUTELARES" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
    <head>
        <title>CRITERIOS_MEDIDAS_CAUTELARES</title>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" CssClass="PCG-Content" AllowSorting="true">
                                            <Columns>
                                                <asp:BoundField DataField="codigo" HeaderText="Código" SortExpression="CRITERIOS_MEDIDAS_CAUTELARES.codigo"></asp:BoundField>
                                                <asp:BoundField DataField="nombre" HeaderText="Nombre" SortExpression="CRITERIOS_MEDIDAS_CAUTELARES.nombre"></asp:BoundField>
