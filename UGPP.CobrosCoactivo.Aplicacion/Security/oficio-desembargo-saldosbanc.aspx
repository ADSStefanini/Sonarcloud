<%@ Page CodeBehind="oficio-desembargo-saldosbanc.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="coactivosyp.oficio_desembargo_saldosbanc" %>
		...
		<div id="wrap">
			...
			<div id="titulo-reporte">
				<div style="border: 1px solid black; width:600px;">
					OFICIO DE DESEMBARGO DE SALDOS BANCARIOS No.
			...
			<div id="contenido">
				<div id="contenido-texto">
					...
					<% Response.Write(NumProceso) %>
					de fecha 30 de septiembre de 2002 ordenó el desembargo de las cuentas corrientes, cuentas de ahorro, 
					C.D.T., encargo fiduciario, facturación de la tarjeta de crédito del banco, o cualquier otro título que 
					tenga el cliente o se expida a favor de este, del contribuyente arriba citado.					
					<br />
					<br />
