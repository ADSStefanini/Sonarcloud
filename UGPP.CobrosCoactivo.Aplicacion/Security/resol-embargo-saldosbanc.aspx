<%@ Page CodeBehind="resol-embargo-saldosbanc.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="coactivosyp.resol_embargo_saldosbanc" %>
		...
		<div id="wrap">
			...
			<div id="titulo-reporte">
				<div style="border: 1px solid black; width:600px;">
					RESOLUCION DE EMBARGO DE SALDOS BANCARIOS No.
			...
			<div id="contenido">
				<div id="contenido-texto">
					...
					con fundamento en la Liquidación Oficial de Aforo No.  <b><% Response.Write(NumProceso) %></b> de fecha 
					09 de mayo de 2000, suscrita por el  funcionario ejecutor del grupo de liquidación oficial , contentivo de la 
					obligación tributaria  que a continuación se discrimina:
					<br /><br />
				...
				<div id="contenido-texto">
					...
					Ordenar el embargo de las cuentas corrientes, cuentas de ahorro, C.D.T.,  encargo fiduciario, facturación de la tarjetas de crédito  o  
