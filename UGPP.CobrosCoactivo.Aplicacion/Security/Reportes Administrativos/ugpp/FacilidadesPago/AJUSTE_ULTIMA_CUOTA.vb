...
Public Class AJUSTE_ULTIMA_CUOTA
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "AJUSTE_ULTIMA_CUOTA.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "coactivosyp.AJUSTE_ULTIMA_CUOTA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAJUSTE_ULTIMA_CUOTA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AJUSTE_ULTIMA_CUOTA = New AJUSTE_ULTIMA_CUOTA
        rpt.Site = Me.Site
        Return rpt
    End Function
