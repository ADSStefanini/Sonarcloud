...
Public Class Carta_Cobro_Persuasivo_002
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Carta_Cobro_Persuasivo_002.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "coactivosyp.Carta_Cobro_Persuasivo_002.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DirLocalidad() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCarta_Cobro_Persuasivo_002
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Carta_Cobro_Persuasivo_002 = New Carta_Cobro_Persuasivo_002
        rpt.Site = Me.Site
        Return rpt
    End Function
