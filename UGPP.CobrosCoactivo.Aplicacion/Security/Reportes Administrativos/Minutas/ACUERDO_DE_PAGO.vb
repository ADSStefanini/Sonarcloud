...
Public Class ACUERDO_DE_PAGO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "coactivosyp.ACUERDO_DE_PAGO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedACUERDO_DE_PAGO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ACUERDO_DE_PAGO = New ACUERDO_DE_PAGO
        rpt.Site = Me.Site
        Return rpt
    End Function
