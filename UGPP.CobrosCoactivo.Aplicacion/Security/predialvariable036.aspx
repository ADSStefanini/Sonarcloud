<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="predialvariable036.aspx.vb" Inherits="coactivosyp.predialvariable036" ValidateRequest="false" %>
...
<body>
    ...
    <div id="container">
        <h1 id="Titulo"><a href="#">(036) TERMINA PROCESO, LEVANTA MED. CAUT. Y ARCHIVA EXPEDIENTE</a></h1>
        <form id="form1" runat="server" style=" margin-top:-30px;">
            ...
            <div id="Buscador" style="width:760px; height:96px; position:relative; top: 40px; margin-left:6px; color:White" >                
                ...
                <div id="texto-normal" style="text-align:left; width: 774px; height: 115px;">
                 ...
                 <div class="separarBoton" style="position:absolute; left:0px; top:140px; width:774px; ">
                    <div class="boton">
