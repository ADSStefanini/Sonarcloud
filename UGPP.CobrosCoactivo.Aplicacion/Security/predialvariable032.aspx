<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="predialvariable032.aspx.vb" Inherits="coactivosyp.predialvariable032" ValidateRequest="false" %>
...
<body>
    ...
    <div id="container">
        <h1 id="Titulo"><a href="#">(032) Declara probada excepciones parcialmente</a></h1>
        <form id="form1" runat="server" style=" margin-top:-30px;">
            ...
            <div id="Buscador" style="width:760px; height:96px; position:relative; top: 40px; margin-left:6px; color:White" >                
               ...
               <div class="texto-negrilla"> CONSIDERACIONES:<br />
                ...
                <div style="width: 773px;background-color:White">
                <textarea id="TxtArea2" runat="server" style="width:770px; height:114px;" ></textarea></div>
                <br />
                <div class="texto-negrilla"> RESUELVE :<br />
                </div>
