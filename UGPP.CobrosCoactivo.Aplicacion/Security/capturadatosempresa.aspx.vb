...
Partial Public Class capturadatosempresa
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.Page.IsPostBack Then
            ...
            If sihaydoc = True Then
                ...
                txtEmpresa.Text = myTable.Rows(0).Item("doc_nombresecuestre")
                txtvalor.Text = myTable.Rows(0).Item("doc_liqtot")
                txtcuenta.Text = myTable.Rows(0).Item("doc_detalle1")
    ...
    Protected Sub btnImprimir_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnImprimir.Click
        ...
        Using connection As New SqlConnection(IIf(Session("ConexionServer").ToString = Nothing, Funciones.CadenaConexion, Session("ConexionServer")))
            ...
            Try
                ...
                command.Parameters.AddWithValue("@doc_liqtot", txtvalor.Text)
                command.Parameters.AddWithValue("@doc_detalle1", txtcuenta.Text)


                If actualizar = 1 Then
                    command.CommandText = UCase("UPDATE entra_documentoma SET doc_detalle1=@doc_detalle1, doc_deudornombre=@doc_deudornombre, doc_deudorcedula=@doc_deudorcedula, doc_nombresecuestre=@nombresecuestre, doc_liqtot=@doc_liqtot, doc_expediente=@EXPEDIENTE,doc_actoadministrativo=@actoadmin,doc_impuesto=@IMPUESTO WHERE doc_expediente =@EXPEDIENTE and doc_actoadministrativo = @actoadmin")

                Else
                    command.CommandText = UCase("INSERT INTO entra_documentoma (doc_detalle1,doc_deudorcedula,doc_deudornombre,doc_expediente,doc_actoadministrativo,doc_impuesto,doc_nombresecuestre,doc_liqtot) VALUES(@doc_detalle1,@doc_deudorcedula,@doc_deudornombre,@EXPEDIENTE,@actoadmin,@IMPUESTO, @nombresecuestre,@doc_liqtot)")
                End If
