...
Public Class rptNroPredio_x_Deudor
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptNroPredio_x_Deudor.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "coactivosyp.rptNroPredio_x_Deudor.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IMPUESTO() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptNroPredio_x_Deudor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNroPredio_x_Deudor = New rptNroPredio_x_Deudor
        rpt.Site = Me.Site
        Return rpt
    End Function
