Partial Public Class generador_expedientes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            If Session("impActAdmin") <> True Then
                impActAdmin.Attributes.Add("class", "dialog_link")
            End If

            If Session("ejecuActuac") <> True Then
                ejecuActuac.Attributes.Add("class", "dialog_link")
            End If

            If Session("salcontrires") <> True Then
                salcontrires.Attributes.Add("class", "dialog_link")
            End If

            'If Session("meResolAcumulado") <> True Then
            '    meResolAcumulado.Attributes.Add("class", "dialog_link")
            'End If
        End If
    End Sub
End Class