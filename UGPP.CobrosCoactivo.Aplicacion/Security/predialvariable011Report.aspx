<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="predialvariable011Report.aspx.vb" Inherits="coactivosyp.predialvariable011Report" %>
...
<body>
    <form id="form1" runat="server">
        <%--<asp:Repeater ID="Repeater_informe" runat="server">
            <HeaderTemplate>
            </HeaderTemplate>
            <ItemTemplate>--%>
                <div id="container">
                    <div id="wrap" class="wrap">	
                            ...
                            <img alt="Firma" 
                                ...
                                id="ImgFirma" height="123" style="width:252px; height:123px;" />
                            <br />
