<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="menu4.aspx.vb" Inherits="coactivosyp.menu4" %>
...
<body>
    <div id="container">
        <h1 id="Titulo"><a href="#">Entradas y datos basicos  - <%  Response.Write(Session("ssCodimpadm") & ".")%></a></h1>
        <div 
        ...
        <form id="form1" runat="server">
            ...
            <div class="ws2" style="position:absolute;top: 89px; left: 43px; width: 697px;">
                <img src="images/icons/Keys.png" alt="" width="75" height="75" /> 
                ...
                <table class="tablamenu">
                    <tr>
                        <td>
                            ...
                            <asp:LinkButton ID="ABack" runat="server"><img alt ="" src="images/icons/UtilisateurSZ.png" height="75" width="75" /></asp:LinkButton>
                        </td>
                        <td>
                            <a id ="usuario" href="usuariosweb.aspx" runat="server"><img alt ="" src="images/usuarios.png" height="75" width="75" /></a>
                        </td>
                        <td>
                            <a id ="caClave" href="usuariosweb_cambioclave.aspx" runat="server"><img alt ="" src="images/icons/Locker.png" height="75" width="75" /></a>
                        </td>
                        <td>
                            <asp:LinkButton ID="A6" runat="server"><img alt ="" src="images/icons/Shutdown.png" height="75" width="75" /></asp:LinkButton>
                        </td>
                    </tr>
                    <tr>
                      <td>
                          <asp:Label ID="lblMenuPpal" runat="server" Text="Menú Principal"></asp:Label></td>
           ...
           <table style="top: 448px; left: 97px; position: absolute;width: 585px;" border="0" 
          ...
          <div style=" width:690px; padding:5px;background:#0b4295;top:365px; left:43px; position: absolute;color:#FFF;border:solid 1px #283e68;">
			   <h2 style="margin:0px; padding:0px; text-transform:uppercase;">Tecno Expedientes !</h2>
			   <h3 style="margin:0px; padding:0px;"> <%  Response.Write(Session("ssCodimpadm") & ".")%> </h3>
		  </div>
