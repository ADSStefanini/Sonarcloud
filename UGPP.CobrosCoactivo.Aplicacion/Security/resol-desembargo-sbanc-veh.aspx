<%@ Page CodeBehind="resol-desembargo-sbanc-veh.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="coactivosyp.resol_desembargo_sbanc_veh" %>
		...
		<div id="wrap">
			...
			<div id="titulo-reporte">
				<div style="border: 1px solid black; width:600px;">
					RESOLUCION DE DESEMBARGO DE SALDOS BANCARIOS No.
			...
			<div id="contenido">
				<div id="contenido-texto">
					El suscrito funcionario ejecutor del cobro  administrativo coactivo del Departamento,en uso de sus  facultades, y  
					teniendo en cuenta que por Resolución de Embargo de Saldos Bancarios No.  <b><% Response.Write(NumProceso) %></b> de fecha 
					09 de mayo de 2000 contentivo de la obligación tributaria  que a continuación se discrimina:
					<br /><br />
				...
				<div id="contenido-texto">
                    ...
                    <br /><br />
					y teniendo en cuenta que el contribuyente ha extinguido la obligación tributaria antes mencionada,
				</div>
				...
				<div id="contenido-texto">
					...
					Ordenar el desembargo de las cuentas corrientes, cuentas de ahorro, C.D.T.,  encargo fiduciario, facturación de la tarjetas de crédito  o  
					cualquier otro título que tenga el contribuyente <b><% Response.Write(Trim(objDataReader("nombre"))) %></b> identificado con 
					la C.C. o NIT. <b><% Response.Write(Trim(objDataReader("veh_cedula"))) %></b>.
