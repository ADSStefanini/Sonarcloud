...
<%@ Page CodeBehind="citacion-resolucion-ordena-ejecucion.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="coactivosyp.citacion_resolucion_ordena_ejecucion" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<HTML>
	<HEAD>
		<title>Citación de la Resolución que ordena llevar adelante la Ejecución</title>
			...
			<div id="contenido">				
				<div id="contenido-texto">
					<div style="text-align:right; margin-top:40px;">
							<b>Oficio No. <% Response.Write(Trim(objDataReader("numproceso"))) %></b>
					</div>
					<!--
					<div class="etiqueta-cabecera" style="width=100%; text-align:right; background-color:red">
						Oficio No. :<% Response.Write(Trim(objDataReader("numproceso"))) %>
					</div>
					-->
					<br>
					<br>
					...
					<br>
					<br>										
					Ref.: Proceso de cobro administrativo coactivo No. <% Response.Write(Trim(objDataReader("numproceso"))) %>
					<br>
					<br>
					<br>
					Por medio de la presente, le estamos remitiendo copia de la resolución proferida por la Tesorería Distrital 
					de Cartagena de Indias, en la cual se ordena llevar adelante la ejecución dentro del proceso administrativo 
					coactivo de la referencia.
					<br><br>
