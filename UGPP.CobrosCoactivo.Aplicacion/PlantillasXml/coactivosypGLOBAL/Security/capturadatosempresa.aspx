<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="capturadatosempresa.aspx.vb" Inherits="coactivosyp.capturadatosempresa" %>
...
<form id="form1" runat="server">
  ...
  <div id="container">
    <h1 id="Titulo"><a href="#">Cobranzas</a></h1>
     ...
     <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"  ErrorMessage="El campo <strong>NOMBRE DE LA EMPRESA</strong> es requerido. Verifique"  ValidationGroup="textovalidados" ControlToValidate = "txtEmpresa"  Display="None"></asp:RequiredFieldValidator>
     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"  ErrorMessage="El campo <strong>NUMERO DE LA CUENTA</strong> es requerido. Verifique"  ValidationGroup="textovalidados" ControlToValidate = "txtcuenta"  Display="None"></asp:RequiredFieldValidator>
     <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"  ErrorMessage="El campo <strong>TOTAL MONTO</strong> es requerido. Verifique"  ValidationGroup="textovalidados" ControlToValidate = "txtvalor"  Display="None"></asp:RequiredFieldValidator>
     ...
     <div class="Yup divhisto" 
         ...
         <table style="text-align:left; font-size:11px;" class = "ppala" align="center">
            <tr><td  class="cl">Nombre de la Empresa: </td><td class="cl2"><asp:TextBox ID="txtEmpresa" runat="server" style="text-align:center;"></asp:TextBox></td></tr>
            <tr><td  class="cl">Nro. de cuenta : </td><td class="cl2"><asp:TextBox ID="txtcuenta" runat="server" style="text-align:center;"></asp:TextBox></td></tr>
            <tr><td  class="cl">Total Monto: </td><td  class="cl2"><asp:TextBox ID="txtvalor" runat="server" style="text-align:center;"></asp:TextBox></td></tr>
         </table>
