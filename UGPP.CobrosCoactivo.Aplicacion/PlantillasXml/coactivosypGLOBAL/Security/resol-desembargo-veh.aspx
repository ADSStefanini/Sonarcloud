<%@ Page CodeBehind="resol-desembargo-veh.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="coactivosyp.resol_desembargo_veh" %>
		...
		<div id="wrap">
			...
			<div id="titulo-reporte">
				<div style="border: 1px solid black; width:600px;">
					RESOLUCION DE DESEMBARGO DE VEHICULO No. 
			...
			<div id="contenido">
				<div id="contenido-texto">
					...
					teniendo en cuenta que por Resolución de Embargo de vehículo No.  <b><% Response.Write(NumProceso) %></b> de fecha 
				...
				<div id="contenido-texto">
					...
					Ordenar el desembargo del vehículo automotor de placa No. 
