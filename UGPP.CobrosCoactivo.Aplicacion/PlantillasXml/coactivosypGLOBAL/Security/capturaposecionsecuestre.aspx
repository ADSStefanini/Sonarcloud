<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="capturaposecionsecuestre.aspx.vb" Inherits="coactivosyp.capturaposecionsecuestre" %>
    ...
    <h1 id="Titulo"><a href="#">Cobranzas</a></h1>
     ...
     <div class="Yup divhisto" 
         ...
         <table style="text-align:left; font-size:11px;" class = "ppala" align="center">
            ...
            <tr><td  class="cl">Nombre del Secuestre : </td><td class="cl2"><asp:TextBox ID="txtNomSecuestre" runat="server" style="text-align:center;"></asp:TextBox></td></tr>
            <tr><td  class="cl">Nro Carnet : </td><td  class="cl2"><asp:TextBox ID="txtNroCarnet" runat="server" style="text-align:center;"></asp:TextBox></td></tr>
            <tr><td  class="cl">Fecha Diligencia : </td><td class="cl2"><asp:TextBox ID="txtFecDiligencia" runat="server" style="text-align:center;"></asp:TextBox></td></tr>
            <tr><td  class="cl">Hora Diligencia : </td><td class="cl2"><asp:TextBox ID="txtHora" runat="server" style="text-align:center;"></asp:TextBox></td></tr>
            <tr><td  class="cl">Nro Telefonico : </td><td class="cl2"><asp:TextBox ID="txtTelefono" runat="server" style="text-align:center;"></asp:TextBox></td></tr>
         ...
         <asp:CalendarExtender ID="txtFechacreacion_CalendarExtender" runat="server"
            TargetControlID="txtFecDiligencia"
            Format="dd/MM/yyyy"
