<%@ Page CodeBehind="saldo_contrib_res.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="coactivosyp.saldo_contrib_res" %>
...
<HTML>
	<HEAD>
		<title>Saldos por contribuyente resumido</title>
		...
		<div id="wrap">
			<%	
				...
				strSQL = "SELECT pr.id_deudor, pr.numproceso, pr.fechamanda, pr.valormanda, pr.nomdeudor, mp.direccion, mp.dir_establ, mp.id_propiet " & _						
						"FROM procesos pr, maepre mp WHERE pr.id_deudor = mp.refe_cata AND pr.nomdeudor LIKE  '" & pRefeCata & "%'"
			...
			<div id="titulo-reporte">
				SALDOS POR CONTRIBUYENTE RESUMIDO (PREDIOS MOROSOS)
			</div>
			<div id="ciudad-fecha">
