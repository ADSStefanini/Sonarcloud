<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="capturafechafallecimiento.aspx.vb" Inherits="coactivosyp.capturafechafallecimiento" %>
...
<form id="form1" runat="server">
  ...
  <div id="container">
    <h1 id="Titulo"><a href="#">Cobranzas</a></h1>
     ...
     <asp:RequiredFieldValidator ID="rfvfecha" runat="server"  ErrorMessage="El campo <strong>FECHA FALLECIMIENTO</strong> es requerido. Verifique"  ValidationGroup="textovalidados" ControlToValidate = "txtFecFallecimiento"  Display="None"></asp:RequiredFieldValidator>
     ...
     <div class="Yup divhisto" 
         ...
         <table style="text-align:left; font-size:11px;" class = "ppala" align="center">
            <tr><td  class="cl">Fecha Fallecimiento : </td><td class="cl2"><asp:TextBox ID="txtFecFallecimiento" runat="server" style="text-align:center;"></asp:TextBox></td></tr>
            <tr><td  class="cl">Fecha de Interrupción: </td><td class="cl2"><asp:TextBox ID="txtfecinte" runat="server" style="text-align:center;"></asp:TextBox></td></tr>
         </table>
         ...
         <asp:CalendarExtender ID="txtFechacreacion_CalendarExtender" runat="server"
            TargetControlID="txtFecFallecimiento"
            Format="dd/MM/yyyy"
            PopupButtonID="Image1" TodaysDateFormat="dd, MMMM, yyyy"/>
         
          <asp:CalendarExtender ID="CalendarExtender1" runat="server"
            TargetControlID="txtfecinte"
            Format="dd/MM/yyyy"
            PopupButtonID="Image1" TodaysDateFormat="dd, MMMM, yyyy"
