<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EditFORMAS_NOTIFICACION.aspx.vb" Inherits="coactivosyp.EditFORMAS_NOTIFICACION" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
    <head id="Head1" runat="server">
        <title>
            Edición de fotmas de notificación
        </title>
    ...
    <body>
        <form id="form1" runat="server">
            <table id="tblEditFORMAS_NOTIFICACION" class="ui-widget-content">
                <tr>
                    <td>
                        &nbsp;
                    </td>
