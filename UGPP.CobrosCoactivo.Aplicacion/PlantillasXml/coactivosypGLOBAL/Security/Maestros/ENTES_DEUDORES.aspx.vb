...
Partial Public Class ENTES_DEUDORES
    ...
    Protected Sub cmdAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdAddNew.Click
        Response.Redirect("EditENTES_DEUDORES.aspx?pExpediente=" & Request("pExpediente") & "&pTipo=" & Request("pTipo") & "&pScr=" & Request("pScr"))
    End Sub
    ...
    Protected Sub grd_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grd.RowCommand
        If e.CommandName = "" Then
            ...
            '----------------------------------------------------
            Response.Redirect("EditENTES_DEUDORES.aspx?ID=" & ED_Codigo_Nit & "&pExpediente=" & Request("pExpediente") & "&pTipo=" & Request("pTipo") & "&pScr=" & Request("pScr") & "&pNomTipoDeudor=" & NomTipoDeudor)
        End If
    End Sub
