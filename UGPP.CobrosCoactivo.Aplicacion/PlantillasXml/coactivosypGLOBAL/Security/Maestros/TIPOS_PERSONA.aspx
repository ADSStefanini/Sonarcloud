<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TIPOS_PERSONA.aspx.vb" Inherits="coactivosyp.TIPOS_PERSONA" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
    <head>
        <title>TIPOS_PERSONA</title>
                                ...
                                <td>
                                    <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" CssClass="PCG-Content" AllowPaging="true" AllowSorting="true">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="codigo" HeaderText="Código" SortExpression="TIPOS_PERSONA.codigo"></asp:BoundField>
                                            <asp:BoundField DataField="nombre" HeaderText="Nombre" SortExpression="TIPOS_PERSONA.nombre"></asp:BoundField>
                        ...
                        <div class="hidden">
                            <div id="dialog" title="Actualizar">
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
                                    <ContentTemplate>
                                        <table id="tblEditDialogTIPOS_PERSONA" class="ui-widget-content">
                                            <tr>
                                                <td>
                                                    &nbsp;
                                                </td>
