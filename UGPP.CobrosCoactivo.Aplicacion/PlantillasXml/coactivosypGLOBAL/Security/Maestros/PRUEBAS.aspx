<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PRUEBAS.aspx.vb" Inherits="coactivosyp.PRUEBAS1" %>
                    ...
                    <td>
                        ...
                        <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" CssClass="PCG-Content">
                            <Columns>
                                ...
                                <asp:BoundField DataField="NroAutoPru" HeaderText="No. Resolución que decreta pruebas"></asp:BoundField>
                                <asp:BoundField DataField="FecAutoPru" HeaderText="Fecha Resolución que decreta pruebas" DataFormatString="{0:dd/MM/yyyy}"></asp:BoundField>
                                <asp:BoundField DataField="FecIniTerPro" HeaderText="Inicio término probatorio" DataFormatString="{0:dd/MM/yyyy}"></asp:BoundField>
                                <asp:BoundField DataField="FecFinTerPro" HeaderText="Fin término probatorio" DataFormatString="{0:dd/MM/yyyy}"></asp:BoundField>
