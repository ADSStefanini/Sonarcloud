...
Partial Public Class MAESTRO_TITULOS
    ...
    Private Function GetSQL() As String
        Dim sql As String = ""
        sql = sql & "select MAESTRO_TITULOS.*, TIPOS_TITULOMT_tipo_titulo.nombre as TIPOS_TITULOMT_tipo_titulonombre, " & _
            "FORMAS_NOTIFICACIONMT_for_notificacion_titulo.nombre as FORMAS_NOTIFICACIONMT_for_notificacion_titulonombre " & _
            "from ([dbo].[MAESTRO_TITULOS] " & _
            "left join [TIPOS_TITULO] TIPOS_TITULOMT_tipo_titulo on [dbo].[MAESTRO_TITULOS].MT_tipo_titulo = TIPOS_TITULOMT_tipo_titulo.codigo )  " & _
            "left join [FORMAS_NOTIFICACION] FORMAS_NOTIFICACIONMT_for_notificacion_titulo " & _
            "on [dbo].[MAESTRO_TITULOS].MT_for_notificacion_titulo = FORMAS_NOTIFICACIONMT_for_notificacion_titulo.codigo " & _
