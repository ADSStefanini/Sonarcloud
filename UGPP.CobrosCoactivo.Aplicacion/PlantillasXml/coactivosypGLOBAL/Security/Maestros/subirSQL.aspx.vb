...
Partial Public Class subirSQL
    ...
    Private Function TableExport(ByVal expediente As String, Optional ByVal buscar As Boolean = False) As DataTable
        ...
        ElseIf rbVerificacionpago.Checked Then
            ...
            dt.Columns.AddRange(New DataColumn() {New DataColumn("EXPEDIENTE", GetType(String)), _
                                             New DataColumn("NRO_CONSIGNACION_O_NRO_PLANILLA", GetType(String)), _
                                             New DataColumn("NIT_EMPRESA", GetType(String)), _
                                             ...
                                             New DataColumn("FECHA_DE_PAGO", GetType(String)), _
                                             New DataColumn("FECHA_DE_REPORTE_DEL_PAGO_POR_EL_DEUDOR", GetType(String)), _
                                             New DataColumn("FECHA_DE_VERIFICACION_DEL_PAGO", GetType(String)), _
                                             New DataColumn("TITULO_DE_DEPOSITO_JUDICIAL", GetType(String)), _
                                             New DataColumn("CAPITAL_PAGADO", GetType(String)), _
                                             New DataColumn("AJUSTE_DEC_1406", GetType(String)), _
                                             New DataColumn("INTERESES_PAGADOS", GetType(String)), _
                                             New DataColumn("GASTOS_DEL_PROCESO", GetType(String)), _
