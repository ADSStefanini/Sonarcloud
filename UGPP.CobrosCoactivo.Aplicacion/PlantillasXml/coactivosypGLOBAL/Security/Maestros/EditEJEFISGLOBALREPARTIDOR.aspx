            ...
            <div id="tabs">
              ...
              <div id="tabs3">
                    ...
                    <div style="margin-left:2px; margin-top:4px; width:960px; height:740px;">                                                            															
						<iframe src="ENTES_DEUDORES.aspx?pExpediente=<%  Response.Write(Session("ssExpedienteActual"))%>&pTipo=1&pScr=repartidor" width="960" height="740" scrolling="no" frameborder="0"></iframe>
					</div>
                    <!-- Deudores :: fin    -->
              </div>
