<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MUNICIPIOS.aspx.vb" Inherits="coactivosyp.MUNICIPIOS" %>
            ...
            function EndRequestHandler() {
                ...
                $("#dialog").dialog({
                    ...
                    buttons: {
                        ...
                        var cboDialogdepartamento = $("#cboDialogdepartamento").val();
                        if ( cboDialogdepartamento == null ) {
                        $("#txtdepartamento").val('');
                        } else {
                        $("#txtdepartamento").val($("#cboDialogdepartamento").val());
                        }
                        $(this).dialog('close');
                        $("#cmdSave").click();
                    },
            ...
            <tr>
                ...
                <input type="button" name="cmdAddNew" value="Adicionar" id="cmdAddNew"/>
                        ...
                        <asp:TextBox ID="txtSearchnombre" runat="server" ></asp:TextBox></td>
                                    ...
                                    <td>
                                        <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" 
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="codigo" HeaderText="Código" SortExpression="MUNICIPIOS.codigo"></asp:BoundField>
                                                <asp:BoundField DataField="nombre" HeaderText="Nombre" SortExpression="MUNICIPIOS.nombre"></asp:BoundField>
                                                <asp:BoundField DataField="DEPARTAMENTOSdepartamentonombre" HeaderText="Departamento" SortExpression="DEPARTAMENTOSdepartamento.nombre"></asp:BoundField>
                                                <asp:BoundField />
                                            </Columns>
                            ...
                            <div class="hidden">
                                <div id="dialog" title="Acrualizar">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
                                        <ContentTemplate>
                                            <table id="tblEditDialogMUNICIPIOS" class="ui-widget-content">
                                                <tr>
                                                    <td>
                                                        &nbsp;
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox id="txtDialognombre" runat="server" MaxLength="80" CssClass="ui-widget"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList CssClass="ui-widget" id="cboDialogdepartamento" runat="server"></asp:DropDownList>                                                    </td>
                                                </tr>
                                            </table>
                                        </ContentTemplate>
                                        <Triggers>
