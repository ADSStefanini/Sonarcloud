<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TIPOS_TITULO.aspx.vb" Inherits="coactivosyp.TIPOS_TITULO" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
    <head>
        <title>TIPOS_TITULO</title>
                                    ...
                                    <td>
                                        ...
                                        <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" CssClass="PCG-Content" AllowSorting="true">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="codigo" HeaderText="Código" SortExpression="TIPOS_TITULO.codigo"></asp:BoundField>
                                                <asp:BoundField DataField="nombre" HeaderText="Nombre" SortExpression="TIPOS_TITULO.nombre"></asp:BoundField>
