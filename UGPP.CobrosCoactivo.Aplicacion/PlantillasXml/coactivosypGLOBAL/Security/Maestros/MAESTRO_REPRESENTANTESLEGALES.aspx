<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MAESTRO_REPRESENTANTESLEGALES.aspx.vb" Inherits="coactivosyp.MAESTRO_REPRESENTANTESLEGALES" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
    <head>
        <title>MAESTRO_REPRESENTANTESLEGALES</title>
        ...
        <form id="Form1" method="post" runat="server">
            <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0" class="ui-widget-content ui-widget">
                <tr>
                    ...
                    <td>
                    <asp:TextBox ID="txtSearchMRL_Codigo_Nit" runat="server" ></asp:TextBox></td>
                <td class="ui-widget-header">
                    Nombre
                </td>
                <td>
                <asp:TextBox ID="txtSearchMRL_Nombre" runat="server" ></asp:TextBox></td>
                                        <td>                                                    
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" CssClass="PCG-Content" AllowSorting="true">
                                    <Columns>
                                        <asp:BoundField DataField="MRL_Codigo_Nit" >
                                            <ItemStyle CssClass="BoundFieldItemStyleHidden" />
                                            <HeaderStyle CssClass="BoundFieldHeaderStyleHidden" />            
                                        </asp:BoundField>
                                        <asp:BoundField DataField="MRL_Codigo_Nit" HeaderText="No. Identificación" SortExpression="MAESTRO_REPRESENTANTESLEGALES.MRL_Codigo_Nit"></asp:BoundField>
                                        <asp:BoundField DataField="MRL_Nombre" HeaderText="Nombre" SortExpression="MAESTRO_REPRESENTANTESLEGALES.MRL_Nombre"></asp:BoundField>
