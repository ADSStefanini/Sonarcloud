<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="registro-titulo-judicial.aspx.vb" Inherits="coactivosyp.registro_titulo_judicial" %>
...
<body>
   ...
   <div id="container">
        <h1 id="Titulo"><a href="javascript:void(0)">Registro de Titulos Judiciales - <% Response.Write(Session("ssCodimpadm") & ".")%></a></h1>
        ...
        <div style="position:absolute;top:100px;left:50px;color:#fff;">
            <div>
                <div style="float:left; width:200px">Documento</div>
                <asp:TextBox ID="TxtDocumento" MaxLength="20" AutoPostBack="true" runat="server"></asp:TextBox>
            </div>
            <div>
                <div style="float:left; width:200px">Expediente</div>
                <asp:TextBox ID="TxtExpediente" AutoPostBack="false" runat="server"></asp:TextBox>
            </div>        
            <div>
                <div style="float:left; width:200px">Fecha</div>
                <asp:TextBox ID="TxtFecha" runat="server"></asp:TextBox>
            </div>
            <div>
                <div style="float:left; width:200px">Valor</div>
                <asp:TextBox ID="TxtValor" style="text-align:right" runat="server"></asp:TextBox>
            </div>        
            <div>
                <div style="float:left; width:200px">Estado</div>
                <asp:DropDownList runat="server" id ="CmbEstado" >
                    <asp:ListItem Selected="True" Value="0">Entregado</asp:ListItem>
                    <asp:ListItem  Value="1">Aplicado</asp:ListItem>
                </asp:DropDownList>
            </div>        
            <div>
                ...
                &nbsp;<input id="Button1" type="button" value="Cancelar" onclick="parent.location='registro-titulo-judicial.aspx'" style="background-image: url('images/icons/cancel.png');width:85px;" class="Botones"  />
           </div>
