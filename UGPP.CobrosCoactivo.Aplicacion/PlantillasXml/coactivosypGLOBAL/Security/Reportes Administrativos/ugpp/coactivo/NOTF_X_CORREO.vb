...
Public Class NOTF_X_CORREO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "coactivosyp.NOTF_X_CORREO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNOTF_X_CORREO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NOTF_X_CORREO = New NOTF_X_CORREO
        rpt.Site = Me.Site
        Return rpt
    End Function
