...
Public Class generacion_caratula
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "generacion-caratula.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "coactivosyp.generacion-caratula.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedgeneracion_caratula
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As generacion_caratula = New generacion_caratula
        rpt.Site = Me.Site
        Return rpt
    End Function
