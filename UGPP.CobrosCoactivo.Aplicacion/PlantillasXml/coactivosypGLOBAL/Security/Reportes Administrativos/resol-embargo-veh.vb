...
Public Class resol_embargo_veh
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "coactivosyp.resol-embargo-veh.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedresol_embargo_veh
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As resol_embargo_veh = New resol_embargo_veh
        rpt.Site = Me.Site
        Return rpt
    End Function
