<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="menu2.aspx.vb" Inherits="coactivosyp.menu2" %>
...
<body>
    <div id="container">
        <h1 id="Titulo"><a href="#">EXPEDIENTE VIRTUAL - <%  Response.Write(Session("ssCodimpadm") & ".")%></a></h1>
        <div 
        ...
        font-size: 11px; font-weight: 700; top: 44px; left: 44px; padding:7px; width: 688px;" id ="Div1" runat="server">Usuario: <%  Response.Write(Session("ssnombreusuario") & ".")%> </div>
        <form id="form1" runat="server">
            ...
            <div class="ws2" style="position:absolute;top: 89px; left: 43px; width: 697px;">
                ...
                <div style="position:absolute; top:30px; left :100px">EXPEDIENTE VIRTUAL</div>
            </div>
            ...
            <div style="position:absolute;left:84px; top:193px; z-index:1001;">                       
                <table class="tablamenu">
                    <tr>
                        <td>
                            <a id ="A2" href="menu.aspx" runat="server"><img alt ="" src="images/icons/UtilisateurSZ.png" height="75" width="75" /></a>
                        </td>
                        <td>
                           <a id ="ConExp" href="historiaexpediente.aspx" runat="server"><img alt ="" src="images/icons/Paste.png" height="75" width="75" /></a>
                        </td>
                        <td>
                            <a id ="ActExp" href="Digitalizacion/digitalizacion.aspx" runat="server"><img alt ="" src="images/icons/gen-expedientes.png" height="75" width="75" /></a>
                        </td>
                         <td>
                            <a id ="ConDia" href="consultardocumentos2.aspx" runat="server"> <img alt ="" 
                                 src="images/icons/con_Clock.png" height="75" width="75" /></a>
                        </td>
                    </tr>
                    <tr>
                      <td>Menú Principal</td>
                      <td>Consulta de Expediente</td>
                      <td>Actualizar Expediente </td>
                      <td>Consulta Diaria</td>
                    </tr>
                </table>
           </div>
           <div style="position:absolute;left:43px; top:430px; z-index:1001; height: 2px; width: 697px; background-color:#fff;">
           </div>
           <div style="position:absolute;left:313px; top:461px; z-index:1001;">                       
                <table class="tablamenu">
                    <tr>
                        <td>
       ...
       <%--   <div id="Opcionevarias" style="position:absolute;top:409px; left:63px;">
                <asp:LinkButton ID="HyperLinkArchivadores" runat="server">REGISTRO Y CONSULTA DE ARCHIVADORES </asp:LinkButton>
                <asp:LinkButton ID="HyperLinkUExportar" runat="server" title="Esta opción le permite importar información de otra base de datos a Tecno Expedientes facilitando procesos largos de digitalización.">IMPORTACIÓN AUTOMÁTICA DE EXPEDIENTES</asp:LinkButton>
          </div>--%>
        </form>
    </div>
</body>
