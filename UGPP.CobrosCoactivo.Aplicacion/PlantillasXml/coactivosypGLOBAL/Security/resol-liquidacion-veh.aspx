		...
		<div id="wrap">
			...
			<div id="contenido">
				<div id="contenido-texto">
					El funcionario ejecutor del Grupo de Liquidación Oficial de la Secretaría de Gestión Financiera Integral haciendo uso de las
					facultades conferidas por el Decreto Departamental No. 145 de fecha 29 de Marzo del año 2004 y los artículos  643, 691, 
					717 y 719 del Estatuto Tributario Nacional; y en concordancia con el Estatuto Rentas del Departamento del Magdalena.,  
					profiere Liquidación Oficial de Aforo del Impuesto Sobre Vehículos Automotores del(os) periodo(s)  gravable(s) del (os) 
					año(s) que a continuación se hace referencia  al contribuyente  <b><% Response.Write(Trim(objDataReader("nombre"))) %></b>
					propietario(a) del vehículo de placas <b><% Response.Write(Trim(objDataReader("veh_placa"))) %></b>
					<br /><br />
				...
				<div id="contenido-texto">
					Que el contribuyente arriba en mención ha sido notificado el día 09 de Mayo de 2002 por correo certificado del 
					acto administrativo Emplazamiento Previo Por no Declarar del Impuesto Sobre Vehículos Automotores del (os) periodo(s) 
					gravable(s) que a continuación se hace referencia del vehículo arriba enunciado.
					<br /><br />
					Que se encuentra vencido el término de un mes otorgado por el emplazamiento notificado.
					<br /><br />
					Que verificando los archivos de la Tesorería General del Departamento, no aparece(n) la(s) declaración(es) privada(s) del  
					Impuesto Sobre Vehículos Automotores  del(os)   periodo(s)  gravable(s) año(s) que a continuación se hace referencia del 
					vehículo de placas <b><% Response.Write(Trim(objDataReader("veh_placa"))) %></b> de propiedad de  
				...
				<div id="contenido-texto">
					...
					Liquidar oficialmente el Impuesto Sobre Vehículos Automotores, a cargo del contribuyente 					
					<b><% Response.Write(Trim(objDataReader("nombre"))) %></b> identificado con (c.c. NIT)
					<b><% Response.Write(Trim(objDataReader("veh_cedula"))) %></b> propietario (a) del vehículo de placas
					<b><% Response.Write(Trim(objDataReader("veh_placa"))) %></b> correspondiente al(os) periodo(s) 
					gravable(s) de l(os) año(s) y como a continuación se establece:										
					<br /><br />
				</div>
				<div id="contenido-texto">
                    ...
                    <br />
					Más los intereses de mora y las sanciones que se generen desde la fecha  en que se debió efectuar la declaración privada y 
					el pago;   hasta la fecha en que se declare y cancele la obligación.
				</div>
				...
				<div id="contenido-texto">
					...
					Contra esta Liquidación Oficial de Aforo procede el Recurso de Reconsideración, el cual podrá 
					interponerse ante el Grupo de Discusión de la Secretaría de Gestión Financiera Integral  del Magdalena, dentro de los dos 
					meses siguientes a la notificación de esta liquidación.  
					<br /><br />
					<label style="font-weight:bold;">ARTICULO TERCERO:</label>
					 Notifíquese esta Liquidación Oficial de Aforo por correo, mediante envío de una copia del acto 
					 correspondiente a la dirección informada por el contribuyente, y se entenderá surtida en la fecha de recibo del acto 
					 administrativo tributario en la dirección informada por el contribuyente, y en concordancia con el artículo 718 del Estatuto 
					 Tributario Nacional se divulgará a través de un medio de comunicación de amplia difusión. 
					 <br /><br />
					<label style="font-weight:bold;">ARTICULO CUARTO:</label>
					 Se remiten copias de esta Liquidación Oficial de Aforo  al Grupo de Discusión y al Grupo de Cobro 
					 Administrativo Coactivo, para que se adelanten los trámites pertinentes.
				</div>
				<div id="firma">
