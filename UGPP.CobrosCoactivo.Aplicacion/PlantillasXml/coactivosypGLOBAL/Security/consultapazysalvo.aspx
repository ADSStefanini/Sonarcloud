<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="consultapazysalvo.aspx.vb" Inherits="coactivosyp.consultapazysalvo" %>
     ...
     <%--<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        ...
        <div style="top: 192px; left: 21px; position: absolute; height: 234px; width: 738px; overflow:auto; background-color:#2461BF;">
                 <asp:GridView ID="GridView_datos" runat="server" AutoGenerateColumns="False"  width = "1110px"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="EFIGEN" HeaderText="Predio" 
                                    ...
                                    <asp:BoundField DataField="EfiNom" HeaderText="Deudor" 
                                        SortExpression="EfiNom" >
                                    <HeaderStyle HorizontalAlign="Left" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="EfiPerDes" HeaderText="Des." 
                                        SortExpression="EfiPerDes">
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle Width="43px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="EfiPerHas" HeaderText="Has." 
                                        SortExpression="EfiPerHas">
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle Width="43px" />
                                    </asp:BoundField>
                                </Columns>
       ...
       <%-- </ContentTemplate>
         ...
         <asp:Button ID="btnHistorial" runat="server" CssClass="Botones" 
            style="top:518px;left:21px;position:absolute;width:210px;background-image: url('images/icons/process.png');" 
            Text="Genenar oficios de desembargos" />
        ...
        &nbsp;<!-- Criterios de busqueda --><%--<asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
            <ContentTemplate>--%>
             <div id="selectoresBus" class="OpMenuBusquedax">
                  ...
                  <div id="NroPre" style="background-color:#507CD1;"><asp:LinkButton ID="LinkBusPredio" runat="server" CssClass="Ahlink"><%= Session("ssCampoClave")  %></asp:LinkButton></div>
