...
Public Class RptLogoEmpresa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "coactivosyp.RptLogoEmpresa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptLogoEmpresa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLogoEmpresa = New RptLogoEmpresa
        rpt.Site = Me.Site
        Return rpt
    End Function
