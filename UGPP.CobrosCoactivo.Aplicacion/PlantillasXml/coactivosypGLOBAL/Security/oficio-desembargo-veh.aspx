<%@ Page CodeBehind="oficio-desembargo-veh.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="coactivosyp.oficio_desembargo_veh" %>
		...
		<div id="wrap">
			...
			<div id="titulo-reporte">
				<div style="border: 1px solid black; width:600px;">
					OFICIO DE DESEMBARGO DE VEHICULO No. DSB 
			...
			<div id="contenido">
				<div id="contenido-texto">
					...
					E. S. D.
					<br /><br /><br /><br />
					Mediante la presente comunico  a Usted, que este Despacho por Resolución No. 04-DSB <% Response.Write(NumProceso) %>
					de fecha 30 de septiembre de 2002 ordenó el desembargo del vehículo de placa 
					<% Response.Write(Trim(objDataReader("veh_placa"))) %> arriba citado, el cual figura como de  propiedad del 
					contribuyente de la referencia  y /o actual propietario.
					<br /><br />
					Por   lo    anterior     solicito    a   Usted,  se  sirva  registrar  la  medida  y enviar  copia
					del certificado donde  conste  tal inscripción  a la Secretaria de Gestión Financiera Integral
					ubicada en el tercer piso de  la Gobernación del Magdalena, de esta ciudad.
