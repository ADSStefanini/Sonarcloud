<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="capturaempresa.aspx.vb" Inherits="coactivosyp.capturaempresa" %>
...
<form id="form1" runat="server">
  ...
  <div id="container">
    <h1 id="Titulo"><a href="#">Cobranzas</a></h1>
     ...
     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"  ErrorMessage="El campo <strong>Nro. CERTIFICACION</strong> es requerido. Verifique"  ValidationGroup="textovalidados" ControlToValidate = "txtcertificacion"  Display="None"></asp:RequiredFieldValidator>
     <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"  ErrorMessage="El campo <strong>DE</strong> es requerido. Verifique"  ValidationGroup="textovalidados" ControlToValidate = "txtde"  Display="None"></asp:RequiredFieldValidator>
     ...
     <div class="Yup divhisto" 
         ...
         <table style="text-align:left; font-size:11px;" class = "ppala" align="center">
            ...
            <tr><td  class="cl">Nro. certificacion :</td><td class="cl2"><asp:TextBox ID="txtcertificacion" runat="server" style="text-align:center;"></asp:TextBox></td>
            <td  class="cl">de :</td><td class="cl2"><asp:TextBox ID="txtde" runat="server" style="text-align:center;"></asp:TextBox></td></tr>
