...
Partial Public Class EJEFISGLOBAL
    ...
    Public Overridable Property HISTORICO_CLASIFICACION_MANUAL As ICollection(Of HISTORICO_CLASIFICACION_MANUAL) = New HashSet(Of HISTORICO_CLASIFICACION_MANUAL)
